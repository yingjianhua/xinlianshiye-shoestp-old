...
/** Created by IntelliJ IDEA. User: lijie@shoestp.cn Date: 2018/11/20 Time: 16:00 */
public class ActivitySignInAction extends HomeAction<PKContest> {
  @Setter @Getter private String name;
  @Setter @Getter private String email;
  @Setter @Getter private String tel;
  @Setter @Getter private String companyname;

  @Setter @Getter private String inquiry;
  @Setter @Getter private int country;
  @Inject private ActivitySignInsDao activitySignInsDao;
  @Inject private ActivitySignInsOneDao activitySignInsOneDao;

...
/** Created by IntelliJ IDEA. User: lijie@shoestp.cn Date: 2018/11/20 Time: 11:53 */
public class ActivitySignInInfoManageServiceImp implements IActivitySignInInfoManageService {

  @Inject private ActivitySignInsDao activitySignInsDao;
  @Inject private ActivitySignInDelDao activitySignInDelDao;

  @Inject private ActivitySignInDao activitySignInDao;
  @Inject private ActivitySignInsGetDao activitySignInsGetDao;
  ...
  public Page getAllSignInInfo(int start, int limit, int country, String keyword) {
    ...
    for (Object object : resultSet.getItems()) {
      ...
      if (activitySignInInfo.getInquiry() != null
          && activitySignInInfo.getInquiry().length() > 200) {

...
<head>
    ...
    <meta name="description"
          content="SE BLACK Women New Style Ankle Boots With Buckle Fashion Casual Boots,Ankle Boots,Womens Collections">
                                    ...
                                    <ul class="list" style="width: 47px; height: 380px;" binding="${imgs.key.pkey}">
                                        <c:forTokens items="${product.picture}" delims="," var="pic">
                                            <li class="item FontBgColor" pos="${index.index}"><!-- 点击图片后添加样式 current-->
                                                <a href="javascript:;" class="pic_box FontBorderHoverColor thumbnail"
                                                   alt=""
                                                   title="" hidefocus="true">
                                                    <img class="lazy" src="./static/images/blank.gif"
                                                         data-original="${envConfig.imageBaseUrl}${pic}"/>
                                                    <span></span>
                                                </a>
                                                <em class="arrow FontPicArrowXColor"
                                                    style="border-color: transparent transparent transparent rgb(102, 102, 102);"></em>
                                        ...
                                        <ul class="list" style="width: 47px; height: 380px;" binding="${imgs.key.pkey}"
                                            ...
                                            <c:forEach items="${imgs.value}" var="img" varStatus="index">
                                                <c:if test="${not empty img}">
                                                    <li class="item FontBgColor" pos="${index.index}">
                                                        <!-- 点击图片后添加样式 current-->
                                                        <a href="javascript:;"
                                                           class="pic_box FontBorderHoverColor thumbnail" alt=""
                                                           title=""
                                                           hidefocus="true">
                                                            <img class="lazy" src="./static/images/blank.gif"
                                                                 data-original="${envConfig.imageBaseUrl}${img}"/>
                                                            <span></span>
                                                        </a>
                                                        <em class="arrow FontPicArrowXColor"
                                                            style="border-color: transparent transparent transparent rgb(102, 102, 102);"></em>
                            ...
                            <div class="big_box" style="width: 408px; height: 408px; left: 0px; top: 0px;">
                                <div class="magnify" data="">
                                    ...
                                    <div class="detail_img_box"
                                         style="width: 453px; height: 453px; left: 426px; top: -9999px; display: none;">
                                        <img class="detail_img lazy" onerror="$.imgOnError(this)"
                                             src="./static/images/blank.gif"
                                             data-original="./static/images/189feda440.jpg"
                                             style="left: -292.127px; top: -347px; max-width: inherit; max-height: inherit;">
                                    </div>
                                    <div class="rect_mask"
                                         style="width: 231.03px; height: 231.03px; left: 148.985px; top: -9999px; display: none;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="prod_info_form" name="prod_info_form" id="goods_form" target="_blank">
                        <ul class="widget attributes" default_selected="1" data-combination="0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <fmt:formatNumber type="number"
                                                          ...
                                                          maxFractionDigits="1"/>% of the ${saleInfo.count} pairs have
                                        been
                                        completed;
                                        <br>
                            ...
                            <li class="attr_show" name="Color">
                                ...
                                <c:forEach items="${colorShow}" var="color">
										<span class="imgView" class="GoodBorderColor GoodBorderHoverColor"
                                              title="${color.key.name}" binding="${color.key.pkey}">
										<em class="icon_selected"></em>
										<em class="icon_selected_bg GoodBorderBottomHoverColor"></em>
										<c:if test="${color.value !=  ''}">
											<a class="attr_pic">
												<img class="lazy" src="./static/images/blank.gif"
                                                     data-original="${envConfig.imageBaseUrl}${color.value}"
                                                     alt="${color.key.name}">
											</a>
                                        </c:if>
										<c:if test="${color.value == '' }">
                                    ...
                                    <c:forEach items="${colorToSpec}" var="specs">
                                        <c:forEach items="${specs.value}" var="spec">
                                            ...
                                            <li binding="${specs.key.pkey}" style="display:none;" class="spec">
                                                <input type="hidden" value="${supplier.pkey}"
                                                       name="specList[${tally}].supplier"/>
                                                ...
                                                <div class="column">
                                                    ...
                                                    <input type="text" value="0" name="specList[${tally}].qty"
                                                           class="total">
                        ...
                        <div class="widget prod_info_actions">
                            <div class="fl" style="position:relative;">
                                ...
                                <input type="button" value="<s:text name='inq'/>"
                                       style="display:inline-block; background:#333;" class="add_btn buynow"
                                       id="add_to_inquiry">

                                <input type="button" onclick="toAddCart(this)" data="${product.pkey}"
                                       value="<s:text name='Global.Add_To_Cart'/>"
                                       class="add_btn addtocart AddtoCartBgColor" id="addtocart"
                                       style="display: inline-block;">
                                <a onclick="addThisToFavorites(${product.pkey})" id="addFavorite"
                                   class="<c:if test="${favorite == null || favorite == ''}">fav_new_btn</c:if><c:if test="${favorite != null}">fav_ed_btn</c:if>">${product.favoriteCount}</a>

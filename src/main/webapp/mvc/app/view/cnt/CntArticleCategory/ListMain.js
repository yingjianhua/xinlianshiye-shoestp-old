Ext.define('mvc.view.cnt.CntArticleCategory.ListMain',{
...
this.columns =[{text : '名称',width : 100,dataIndex : 'bean.name',sortable : true,renderer : mvc.Tools.JsonRenderer()}
	,{text : '文章类型',width : 100,dataIndex : 'bean.rootid',sortable : true,renderer : mvc.Tools.beanRendererHref(),md : 'cnt',mn : 'view.cnt.CntArticleCategory.List'}
...
onUpdateRecord : function(form, data){
		...
		var bean = Ext.create('mvc.model.cnt.CntArticleCategory', data);
...
onDelRow : function(grid, rowIndex){
		...
		Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg,
			function(btn) {
				...
				Ext.Ajax.request({
					url : '/cnt_CntArticleCategory_del?pkey='+row.get('bean.pkey')+'&rowVersion='+row.get(BEAN_VERSION),

...
public class LgAccessAction extends ActionBase<LgAccess> {
  ...
  @Getter @Setter private String user; // 用户
  @Getter @Setter private String loginName; // 登录名
  @Getter @Setter private String requestUrl; // 请求地址

  /** @Description: 获取访问日志 *@date 2019/1/21 10:39 *@anthor zjl */
  public void getAccessList() throws IOException {
    write(LgAccessDAO.getAccessList(getStart(), getLimit(), user, loginName, requestUrl));
  }

  /** @Description: 统计访问日志 *@date 2019/1/21 11:55 *@anthor zjl */

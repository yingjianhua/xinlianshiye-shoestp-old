                    ...
                    <el-form size="small" label-width="160px" ref="form" :rules="rules" :model="form" id="inquiry_form">
                        <div class="input-wrap required">
                            <el-form-item label-width="0" prop="title">
                                <el-input placeholder="Key words of products you are looking for"
                        ...
                        <div class="form_main">
                            <el-form-item label-width="0" prop="descriotion">
                                <el-input type="textarea" :autosize="{ minRows: 14, maxRows: 14}"
                                          placeholder="Please let suppliers know your detailes requirements. You may include:color,size,material,grade/standard,etc"
                                    ...
                                    <div class="transport-box">
                                        ...
                                        <el-form-item label-width="0">
                                            <el-input v-model="form.destination"
                                                      placeholder="Destination Port"></el-input>
                                        </el-form-item>
                                        <!-- 支付方式 -->
                                        <el-form-item label-width="0">

...
public class OrderMeetingAuditRelease extends BeanInt<OrderMeetingAuditRelease> {
  ...
  public static final Tb TB =
      new Tb(OrderMeetingAuditRelease.class, "发布订购会-审核状态").setAutoIncrement().addActIUDL();
  ...
  public OrderMeetingAuditRelease init() {
    ...
    _status =
        OrderMeetingAuditStatus.DEFAULT
            .getLine()
            .getKey(); // 参加订购会状态 <OrderMeetingAuditStatus>  BYTE
  ...
  public OrderMeeting gtOdrmeeting() {
    if (getOdrmeeting() == null) return null;
    return (OrderMeeting) get(OrderMeeting.class, getOdrmeeting());
  }

  public void stOdrmeeting(OrderMeeting odrmeeting) {
    if (odrmeeting == null) setOdrmeeting(null);
    else setOdrmeeting(odrmeeting.getPkey());
  }

...
public class I18NUtil {
  ...
  private static class ZoneTrans {
    ...
    private static LocalDateTime trans(LocalDateTime time, ZoneId origin, ZoneId target) {
      Integer difference =
          ZonedDateTime.of(time, origin)
              .getOffset()
              .compareTo(ZonedDateTime.of(time, target).getOffset());
  ...
  public static String getBundle(String key) {
    ...
    ResourceBundle bundle =
        ResourceBundle.getBundle("shoestp", new Locale(sessionmsg.getLang().name()));
  ...
  private static class CurrencyFormatter {
    ...
    private static String format(
        BigDecimal price, String currency, String symbol, String shortName) {

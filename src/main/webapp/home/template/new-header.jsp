...
<div class="new_header">
        <div class="wide clean">
            ...
            <ul class="new_nav_item fl" style="overflow: visible;">
                ...
                <li class="item fl">
                    <a href="https://www.shoestp.com/country/Romania-Pantofi-en-gros/romania-index-ro.html" class="ia"><s:text name="romanianOfflineExhibition"/></a>
                </li>
<!--                 <li class="item fl"> -->
...
<!--                 </li> -->
            ...
            <div class="n_search">
                <form action="/home/pdt_PdtProduct" method="get" class="form" style="margin: 0;">
                    <input type="text" class="text fl" placeholder="<s:text name="What_Are_You_Looking_For"/>" name="Keyword" notnull="" value="">

//第一页数据
		...
		var _nav1={
			...
			visit_data:[15146,23628,42057,84115,134584,403751,541027,827771,1200267,1440321,1602510,821215],//访问量--柱形图
			browse_data:[137828,305932,688732,1850526,1959538,10053403,6017297,10385210,14271179,14172757,14354521,7454525],//浏览量--柱形图
			...
			register_data:[174,271,483,966,1546,4638,6215,9510,14620,16547,15697,7564],
			volume_data:[1561554,3646462,2545645,3555458,3469451,4545211,6223142,7545485,8152141,9121221,8312315,5454154],
	        //运营数据
	        operation_data:{
	        ...
	        setting:{
	        	...
	        	//注册量时间设置
	        	register_change_time:[120*1000,300*1000],
	        	...
	        	//采购商时间设置
	        	purchase_change_time:[30*1000,60*1000],

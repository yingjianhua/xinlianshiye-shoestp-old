		...
		<div id="signup">
			...
			<form class="register fl" id="infoForm">
				...
				<div class="row">
					...
					<input name="bean.email" id="Email" class="lib_txt" type="text" size="40" maxlength="100" format="Email" notnull="">
				...
				<div class="row">
					...
					<input name="password" id="Password" class="lib_txt" type="password" size="40" notnull=""  placeholder="<s:text name="pwd_length"/>">
				</div>
				<div class="row">
					<span class="fc_red">*</span>
					<label for="Password2"><s:text name="confirm_password"/>
					</label>
					<input name="password2" id="Password2" class="lib_txt" type="password" size="40" notnull="" placeholder="<s:text name="pwd_length"/>">
				...
				<div class="row">
					...
					<input id="checkCode" name="checkCode"  class="lib_txt fl" type="text" size="10" maxlength="4" notnull="">&nbsp;&nbsp;&nbsp;
					<img src="<%=request.getContextPath()%>/servlet/verify.img" style="vertical-align:top;width:53px;height:28px;line-height:21px;" id="verify"/> </div>
				<dl class="intro">
				...
				<div class="row">
					<button class="signbtn signup form_button_bg" type="button" id="regButton"><s:text name="createAccount"/></button>
				</div>
			</form>
			<div class="info fr">

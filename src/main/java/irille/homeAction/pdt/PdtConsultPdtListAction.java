...
public class PdtConsultPdtListAction extends HomeAction<PdtConsultPdtList>
    implements IPdtConsultPdtListAction {
  ...
  public void list() throws Exception {
    write(
        PdtConsultPdtListDAO.listViewByPurchase(
            getPurchase().getPkey(), supplierId, curLanguage()));
  }

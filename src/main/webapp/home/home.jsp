...
<div id="mix">
                                        ...
                                        <li class="item" v-for="(goods, index) in womanShoesList"
                                            ...
                                            <div class="hover-show">
                                                <div class="hover-text-wrap">
                                                    ...
                                                    <div class="price" v-if="goods.price > 0">
                                                        Price:{{sysConfig.currency_symbol}}
                                                        {{goods.price}}
                                                    </div>
                                                    <div class="tips" v-if="goods.min_order > 0">
                                                        Min.order:
        ...
        <div class="new-products-container">
            ...
            <div class="tip clearfix">
                ...
                <input type="email" v-model="form.email" class="tip-input fl"
                       placeholder="Example:jsun@company.com"/>
                <!-- {{bean.email}} -->
            ...
            <div style=" width:1240px;height:388px;position:relative;left:0;" class="new-swiper">
                <div class="swiper-container swiper-no-swiping" id="new-products-swiper"
                     style="width:1240px;">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" v-cloak v-for="(item, index) in newProductsList"
                             :key="index">
    ...
    <div id="home">
        <div class="top10" style="width: 1240px;margin: 0 auto;">
            ...
            <p style="font-size: 18px;color: #000;line-height: 50px;height: 40px;">Free Alerts on
                newly added
                products! </p>
            ...
            <h2 style="font-size: 40px;height: 80px;line-height: 90px;font-weight: 500;border-bottom: 1px solid #c4c4c4">
                Request
                For Quotation</h2>
            <p style="font-size: 18px;color: #000;height: 60px;line-height: 50px">Customization
                Service</p>
            <a href="javascript:void(0);">
                <div class="top10-01"
                    ...
                    <p style="font-size: 24px;color: #ffffff;line-height: 25px;width: 250px">AN EASY
                        WAY TO SEND BUYING
                        REQUESTS TO SUPPLIERS & GET QUOTES QUICKLY.</p>
                    <ul style="margin-top: 40px">
                        <li style="font-size: 14px;color: white"><span>● </span>Get quotes for your
                            custom request
                        </li>
                        <li style="font-size: 14px;color: white"><span>● </span>Lte the right
                            suppliers find you
                        </li>
                        <li style="font-size: 14px;color: white"><span>● </span>Close deals with one
                            click
                        </li>
                    </ul>
                </div>
                <div class="top10-02"
                    ...
                    <form action="">
                        ...
                        <p style="font-size: 16px;line-height: 42px;color: #a1a1a1;">Select template
                            type :</p>
    ...
    <div id="xc">
        ...
        <div class="crowdfunding-container" style="margin-bottom:15px;">
            <div class="clearfix" style="border-bottom: 1px solid #cccccc;">
                <div class="title fl" style="border:none;line-height: normal;margin-bottom:25px;">
                    Crowdfunding
                </div>
                <div class="tip clearfix fl" style="margin:12px 0 0 15px;">
                    <ul class="tip-list clearfix">
                        <li class="fl">Lower price in small number</li>
                        <li class="fl" style="margin-left:40px;">Fashion Design will be published
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <a href="/home/prm_PrmGroupPurchase_getGroupPdt?pkey=977"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                Leather shoes male Korean version of the trend of
                                                leather shoes men's
                                ...
                                <div class="goods-detail">
                                    <a href="/home/prm_PrmGroupPurchase_getGroupPdt?pkey=870"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                Dingtai Boots Nice High Heel Shoes Womens Winter
                                                Boots
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="goods-detail">
                                    <a href="/home/prm_PrmGroupPurchase_getGroupPdt?pkey=1145"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                Students wild winter hip hop Gaobang men's shoes
                                ...
                                <div class="goods-detail">
                                    <a href="/home/prm_PrmGroupPurchase_getGroupPdt?pkey=883"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                Romania Wholesale Shoes comfortable casual canvas
                                                shoes
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="goods-detail">
                                    <a href="https://www.shoestp.com/home/prm_PrmGroupPurchase_getGroupPdt?pkey=845"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                Wholesale Summer New Design Beaches sandals Men's
                                                sandals
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="goods-detail">
                                    <a href="/home/prm_PrmGroupPurchase_getGroupPdt?pkey=1073"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                Ins tide shoes men's winter old shoes Korean version
                                                of ulzzang new
                                ...
                                <div class="goods-detail">
                                    <a href="/home/prm_PrmGroupPurchase_getGroupPdt?pkey=1143"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                High heels female autumn 2018 new rivet pointed 12
                                                stiletto single shoes
                                ...
                                <div class="goods-detail">
                                    <a href="/home/prm_PrmGroupPurchase_getGroupPdt?pkey=1026"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                New Style Ballet Shoes Wholesale Women Shoes Leather
                                                Flat Shoes
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="goods-detail">
                                    <a href="https://www.shoestp.com/home/prm_PrmGroupPurchase_getGroupPdt?pkey=1094"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                2019 summer soft composite bottom bow toe sandals
                                                Velcro
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="goods-detail">
                                    <a href="/home/prm_PrmGroupPurchase_getGroupPdt?pkey=1133"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                2018 new round head British wind small shoes low
                                                heel tassel fashion
                                ...
                                <div class="goods-detail">
                                    <a href="/home/prm_PrmGroupPurchase_getGroupPdt?pkey=822"
                                       target="_blank">
                                        ...
                                        <div class="goods-title">
                                            <div class="ellipsis_2">
                                                Women Slippers Shoes Summer Female Fashion Shoes

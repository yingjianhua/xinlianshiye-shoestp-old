...
public class Pdt extends PackageBase {
	...
	public enum OTypingType implements IEnumOpt {
		...
		private OTypingType(int key, String name) {_line=new EnumLine(this,key,name);}
	...
	public enum OStockOut implements IEnumOpt {
		...
		private EnumLine _line;
		private OStockOut(int key, String name) {_line=new EnumLine(this,key,name);}
		public EnumLine getLine(){return _line;	}
	}
	/*
	 * 销售状态
	...
	public enum OSatisfaction implements IEnumOpt{
		...
		private EnumLine _line;
		private OSatisfaction(int key , String name){_line = new EnumLine(this,key,name);}
		public EnumLine getLine(){return _line;}
	}
	...
	public enum OProductType implements IEnumOpt{
		GENERAL(0,"普通产品"),GROUP(1,"联合采购产品"),GATHER(2,"采集商品");
		public static final String NAME = "产品种类";
		public static final OProductType DEFAULT = GENERAL;
		private EnumLine _line;
		private OProductType(int key , String name){_line = new EnumLine(this,key,name);}
		public EnumLine getLine(){return _line;}
	}

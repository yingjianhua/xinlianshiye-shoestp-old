...
public class PdtSpec extends BeanInt<PdtSpec> implements IExtName {
	...
	public enum T implements IEnumFld {//@formatter:off
		...
		public static final Index IDX_PDT_COLOR_SIZE = TB.addIndex("pdt_color_size", true, T.PRODUCT,T.COLOR,T.SIZE);
		private Fld _fld;
  ...
  //方法----------------------------------------------
  public static PdtSpec loadUniquePdt_color_size(boolean lockFlag,Integer product,Integer color,Integer size) {
    return (PdtSpec)loadUnique(T.IDX_PDT_COLOR_SIZE,lockFlag,product,color,size);
  }
  public static PdtSpec chkUniquePdt_color_size(boolean lockFlag,Integer product,Integer color,Integer size) {

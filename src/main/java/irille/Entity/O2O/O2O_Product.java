...
@Variable(
    group = {OTempType.O2O_PROD_APPR_NOTICE},
    enumType = O2O_Product.T.class,
    clazz = O2O_Product.class,
    attributes = {
...
public class O2O_Product extends BeanInt<O2O_Product> {
  ...
  ;
    ...
    public static final Tb.Index IDX_PRODUCTID_JOININFOID =
        TB.addIndex("product_id_join_info_id", true, T.PRODUCT_ID, T.JOIN_INFO_ID);
    private Fld _fld;
  ...
  public O2O_Product init() {
    ...
    _verifyStatus =
        O2O_ProductStatus.DEFAULT.getLine().getKey(); // O2O商品状态 <O2O_ProductStatus>  BYTE
  ...
  // 方法----------------------------------------------
  public static O2O_Product loadUniqueProduct_id_join_info_id(
      boolean lockFlag, Integer productId, Integer joinInfoId) {
    return (O2O_Product) loadUnique(T.IDX_PRODUCTID_JOININFOID, lockFlag, productId, joinInfoId);
  }

  public static O2O_Product chkUniqueProduct_id_join_info_id(
      boolean lockFlag, Integer productId, Integer joinInfoId) {
  ...
  public O2O_JoinInfo gtJoinInfoId() {
    if (getJoinInfoId() == null) return null;
    return (O2O_JoinInfo) get(O2O_JoinInfo.class, getJoinInfoId());
  }

  public void stJoinInfoId(O2O_JoinInfo joinInfoId) {
    if (joinInfoId == null) setJoinInfoId(null);
    else setJoinInfoId(joinInfoId.getPkey());
  }

...
<div id="main" class="wide">
    ...
    <div id="lib_cart">
                ...
                <ul>
                    <div id="showads">
                        ...
                        <li id="lib_address" style="display: list-item;">
                            <a id="addAddress" href="javascript:;" class="textbtn" onclick="showaddform()">Add a New
                                Shipping Address</a>
                        </li>
                    </div>
                    <div id="addshowform" style="display: none;">
                        <form id="addform">
                            ...
                            <table class="tb-shippingAddr">
                                ...
                                <tr>
                                    ...
                                    <td class="recipient">
                                        <div>
                                            <input type="text" id="FirstName" name="bean.name" maxlength="32"
                                                   class="elmbBlur">
                                            <p><span class="required">*</span>&nbsp;First Name</p>
                                            <p class="errorInfo"></p>
                                        </div>
                                        <div>
                                            <input type="text" id="LastName" name="bean.surname" maxlength="32"
                                                   class="elmbBlur">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="emailcode" name="bean.emailcode" maxlength="10"
                                               class="elmbBlur">p class="errorInfo"></p> </td>
                                </tr>
                                <tr>
                                    <th><span class="required">*</span><label>Destination Country/Region:</label></th>
                                    <td><select name="bean.country" placeholder="Please Choose Your Country"
                                                id="country"></select>
                                ...
                                <tr id="taxCode" style="display: none;">
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="tax_code_value" id="taxCodeValue" maxlength="11"
                                               class="taxCodeValue elmbBlur" disabled="disabled">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="address" name="bean.address" maxlength="100"
                                               class="elmbBlur">
                                        <p class="errorInfo"></p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="left editableSelect hasLayout">
                                            <input type="text" id="phonenumber" name="bean.phonenumber"
                                                   class="phoneNum elmbBlur" maxlength="15" autocomplete="off">
                        ...
                        <button class="useAddress" type="submit" class="textbtn" onclick="useaddress()">Use This
                            Shipping Address
                        </button>
                    </div>
                    ...
                    <div id="updshowform" style="display: none;">
                        <form id="updform">
                            ...
                            <table class="tb-shippingAddr">
                                ...
                                <tr>
                                    ...
                                    <td class="recipient">
                                        <div>
                                            <input type="text" id="updname" name="bean.name" maxlength="32"
                                                   class="elmbBlur">
                                            <p>
                                        ...
                                        <div>
                                            <input type="text" id="updsurname" name="bean.surname" maxlength="32"
                                                   class="elmbBlur">
                                            <p>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="updemailcode" name="bean.emailcode" maxlength="10"
                                               class="elmbBlur">
                                        <p class="errorInfo"></p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select name="bean.country" placeholder="Please Choose Your Country"
                                                id="updcountry">
                                        </select>
                                        <p class="errorInfo"></p>
                                    </td>
                                ...
                                <tr id="state" style="display: table-row;">
                                    ...
                                    <td>
                                        <input type="text" name="bean.region" id="updregion" maxlength="32"
                                               class="elmbBlur">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="bean.city" id="updcity" maxlength="30"
                                               class="elmbBlur">
                                        <p class="errorInfo"></p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="updaddress" name="bean.address" maxlength="100"
                                               class="elmbBlur">
                                        <p class="errorInfo"></p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="left editableSelect hasLayout">
                                            <input type="text" id="updphonenumber" name="bean.phonenumber"
                                                   class="phoneNum elmbBlur" maxlength="15" autocomplete="off">
                                            <ul id="otherPhones"></ul>
                                            <p class="errorInfo"></p>
                                        </div>
                        ...
                        <button class="useAddress" type="submit" class="textbtn" onclick="updform()">Use This Shipping
                            Address
                        </button>
                    </div>
        ...
        <form id="PlaceOrderFrom" method="post" action="https://www.shoestp.com/cart/" amountprice="14000.00"
              userprice="0" userratio="100">
            <div class="cartFrom">
                            ...
                            <dl>
                                <dt>
                                    <a href="https://www.shoestp.com/debang-block-heel-puleather-knee-high-winter-warm-boots-for-women_p6041.html">
                                        <img src="./static/images/c0b8f9ba88.jpg.240x240.jpg"
                                             alt="Debang Block Heel Puleather Knee High Winter Warm Boots For Women"
                                ...
                                <dd>
                                    <h4>
                                        <a href="https://www.shoestp.com/debang-block-heel-puleather-knee-high-winter-warm-boots-for-women_p6041.html"
                                           title="Debang Block Heel Puleather Knee High Winter Warm Boots For Women">Debang
                                            Block Heel Puleather Knee High Winter Warm Boots For Women</a>
                                    </h4>
                                    <p>TOPDB1283</p>
                            ...
                            <ul>
                                <li>
                                    <input type="radio" name="_shipping_method[276]" value="257" price="0" insurance="0"
                                           shippingtype="" cid="5" checked="checked">Free mail:
                                </li>
                            </ul>
                        </td>
...
<div id="new_foot">
    <div class="wide">
        <div class="foot_list fl">
            ...
            <div class="item">
                <a href="https://www.shoestp.com/art/about-payment_a0061.html" title="About Payment" target="_blank">About
                    Payment</a>
            </div>
            <div class="item">
        ...
        <div class="foot_list fl">
            ...
            <div class="item">
                <a href="https://www.shoestp.com/art/privacy-policy_a0065.html" title="Privacy Policy" target="_blank">Privacy
                    Policy</a>
            </div>
            <div class="item">
                <a href="https://www.shoestp.com/art/terms-amp-conditions_a0064.html" title="Terms &amp; conditions"
                   target="_blank">Terms &amp; conditions</a>
            </div>
            <div class="item">
                <a href="https://www.shoestp.com/art/return-policy_a0063.html" title="Return Policy" target="_blank">Return
                    Policy</a>
            </div>
        </div>
        <div class="foot_list fl">
            ...
            <div class="item">
                <a href="https://www.shoestp.com/art/about-shoestpcom_a0067.html" title="About shoestp.com"
                   target="_blank">About shoestp.com</a>
            </div>
            <div class="item">
                <a href="https://www.shoestp.com/art/shoestp-cooperation-program_a0066.html"
                   title="ShoeSTP Cooperation Program"
                   target="_blank">ShoeSTP Cooperation Program</a>
            </div>
            <div class="item">
                <a href="https://www.shoestp.com/art/contact-us_a0062.html" title="Contact Us" target="_blank">Contact
                    Us</a>
            </div>
            <div class="item">
            ...
            <div class="fc fl">
                ...
                <div class="fl fcfollow">
                    <div class="follow_toolbox clearfix">
                        <ul>
                            <li>
                                <a rel="nofollow" class="follow_facebook"
                                   href="https://www.facebook.com/ShoeslogoShoestp/?ref=bookmarks"
                                   target="_blank" title="Facebook">Facebook</a>
                            </li>
                            <li>
                                <a rel="nofollow" class="follow_twitter" href="https://twitter.com/shoes_logo"
                                   target="_blank"
                                   title="Twitter">Twitter</a>
                            </li>
                            <li>
                                <a rel="nofollow" class="follow_pinterest" href="https://www.pinterest.com/shoeslogo/"
                                   target="_blank"
                                   title="Pinterest">Pinterest</a>
                            </li>
                            <li>
                                <a rel="nofollow" class="follow_youtube"
                                   href="https://www.youtube.com/channel/UCUHObFxGQ_FaHCKolyZ9k0w"
                                   target="_blank" title="YouTube">YouTube</a>
                            </li>
                            <li>
                                <a rel="nofollow" class="follow_linkedin"
                                   href="http://www.linkedin.com/company/13430792/admin/updates/"

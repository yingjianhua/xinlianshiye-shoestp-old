...
// 针对https也开启代理
    ...
    public AnalyticsReporting initializeAnalyticsReporting() throws GeneralSecurityException, IOException {
        ...
        GoogleCredential credential = GoogleCredential
                .fromStream(this.getClass().getResourceAsStream("/GoogleAnalytics/client_id.json"))
...
//        Dimension cohortPageviewsPerUser = new Dimension().setName("ga:cohortPageviewsPerUser");

                    ...
                    <ul class="ui_border_t menu_son">
                        <li class="item son">
                            ...
                            <ul class="menu_son menu_grandson">
                                ...
                                <li class="item">
                                    <a href="https://www.shoestp.com/c/mens-leather-shoes_0527"
                                ...
                                <li class="item">
                                    <a href="https://www.shoestp.com/c/loafersampslip-ons_0400"
                    ...
                    <ul class="ui_border_t menu_son">
                        <li class="item son">
                            ...
                            <ul class="menu_son menu_grandson">
                                ...
                                <li class="item">
                                    <a href="https://www.shoestp.com/c/boys-sports-shoes_0515"
                                       title="Boys sports shoes">
                                        Boys sports shoes
                                    </a>
                                </li>
                                <li class="item">
                                    <a href="https://www.shoestp.com/c/boys-casual-shoes_0516"
                                       title="Boys casual shoes">
                                        Boys casual shoes
                                    </a>
                                </li>
                                <li class="item">
                        ...
                        <li class="item son">
                            ...
                            <ul class="menu_son menu_grandson">
                                ...
                                <li class="item">
                                    <a href="https://www.shoestp.com/c/girls-sports-shoes_0389"
                                       title="Girls sports shoes">
                                        Girls sports shoes
                                    </a>
                                </li>
                                <li class="item">
                                    <a href="https://www.shoestp.com/c/girls-casual-shoes_0391"
                                       title="Girls casual shoes">
                                        Girls casual shoes
                                    </a>
                                </li>
                                <li class="item">
                                ...
                                <li class="item">
                                    <a href="https://www.shoestp.com/c/girls-dress-shoes_0510"
                                       title="Girls dress shoes">
                                        Girls dress shoes
                                    </a>
                                </li>
                            </ul>
            ...
            <div class="main_left">
                ...
                <form action="https://www.shoestp.com/inquiry.html" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form_main marginBottom">
                                <textarea name="Message" id="content" class="form_textarea"
                                          placeholder=" Product Detailed Specifications.Describe about your perferred unit price,destination port and the payment methods."
                                          notnull="">
                                </textarea>
                        <div class="clean">
                            <div class="flex">
                    ...
                    <div class="form_footer marginBottom">
                        ...
                        <div class="form_code" style="width:32%">
                            <img src="./static/images/v_code.class.php"
                                 onclick="this.src=&quot;/inc/class/v_code.class.php?name=inquiry&amp;length=4&amp;charset=en&amp;r=&quot;+Math.random();"
                ...
                <div>
                    <div>
                        <input name="Submit" type="button" class="submit" id="sub_btn" value="Submit"
                               onclick="inquiries()">
                    </div>
                </div>

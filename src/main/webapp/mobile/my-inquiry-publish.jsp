...
<html lang="en">
    <head>
        ...
        <link href="/home/static/themes/default/mobile/css/xunpanMC.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/home/static/themes/default/mobile/js/kindeditor-all-min.js"></script>
                ...
                <div class="main">
                    ...
                    <div class="main_left">
                        ...
                        name="inquiry" id="inquiry_form">
                            ...
                            <div class="form_header marginBottom">
                                <input id="title" class="selected-product-name inputHeight marginRight" notnull="" placeholder="<s:text name="title" />" v-model.lazy.trim="submitObj.v.title"/>
                                <div class="btn-select-product" @click="toSelectPdt"><!-- Select Product --><s:text name="selectProduct" /></div>
                            </div>
                            ...
                            <div class="modal-wrap choose-goods-wrap">
                              ...
                              <div class="modal-content">
                                <div class="choose-goods-list">
                                  ...
                                  <div class="goods-item clean"
                                    ...
                                    <div class="goods-pic fl">
                                      <img :src="'${envConfig.imageBaseUrl}'+goods.imgs.split(',')[0] || '/home/static/themes/default/mobile/images/1ed13be5ce.jpg.500x500.jpg'" alt="">
                                    </div>
                                    <!-- 商品描述 -->
                                    <div class="goods-descript">
                                      ...
                                      <div class="goods-spec">
                                        ...
                                        <div class="close" :data-goods-id="goods.id">&times;</div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div v-show="goodsList.length==0" style="text-align: center;padding: 15px;">
                              ...
                              <div class="modal-footer flex">
                                <label for="use-title" class="flex-grow">
                                  ...
                                  <span style="color: #777;"><!-- Use products title as RFQ title --><s:text name="RFQ_title" /></span>
                                </label>
                                ...
                                <div>
                                  <input class="btn" type="button" value="Submit" @click="submitSelectedGoods">
                                    <input class="btn btn-cancel-chooseGoods" type="reset" value="Cancel" @click="cancelSelectedGoods">
                                </div>
                              </div>
                            </div>
                            <div class="modal"></div>
                            ...
                            <div class="form_header marginBottom">
                                <input name="LastName" value="" type="text" placeholder=" <s:text name="user.name" />" class="inputHeight marginRight"
                                style="width:40%" notnull="" v-model.lazy.trim="submitObj.v.name">
                                <input name="Email" value="" type="text" placeholder=" <s:text name="user.email" />" class="inputHeight"
                                style="width:60%" notnull="" v-model.lazy.trim="submitObj.v.email">
                            </div>
                            <div class="form_header marginBottom">
                                <select name="Country" notnull="" class="inputHeight" style="width: 100%;" v-model="submitObj.v.country">
                                    <option value="undefined">
                                        ---<!-- Please Select Your Country --><s:text name="mobile.plz_sel" />---
                                    </option>
                            ...
                            <!-- Product Detailed Specifications. Describe about your perferred unit price, destination port and the payment methods. -->
                                <textarea name="Message" id="" class="form_textarea" placeholder=" <s:text name="Product_detailed" />"
                                ...
                                <div class="clean">
                                    ...
                                    <div class="imgbox" v-if="selectGoodsIndex != -1">
                                        <div class="imgnum">
                                            <img :src="'${envConfig.imageBaseUrl}'+goodsList[selectGoodsIndex].imgs.split(',')[0]" class="img-show" />
                                        </div>
                                    </div>

                                    <%-- 添加后显示的imgs --%>
                                    <div class="imgbox" v-if="imgsToUpload.length > 0" v-for="(imgUrl, index) in imgsToUpload">
                                        <div class="imgnum">
                                            <span class="close" :data-index="index" @click="deleteImg"><s:text name="user.delete" /></span>
                                            <img :src='"${envConfig.imageBaseUrl}"+imgUrl' class="img-show" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="imgbox imgbox-add" v-show="(selectGoodsIndex >= 0 && imgsToUpload.length < 4) || (selectGoodsIndex == -1 && imgsToUpload.length <= 4)">
                                        <div class="imgnum">
                                            <input type="file" class="filepath" id="input-img" accept="image/png,image/gif,image/jpeg"
                                              @change="changeImg"/>
                                            <img src="/home/static/themes/default/mobile/images/icon-add-pic.png" class="btn-add-img" />
                                        </div>
                                    </div>
                            ...
                            <div class="form_footer marginBottom">
                                <input name="Subject" type="text" placeholder=" <s:text name="enterQuantity" />" class="inputHeight" notnull=""
                                style="width:30%;margin-right:0.5rem;" v-model.lazy.trim.number="submitObj.v.quantity">
                                <input name="VCode" type="text" placeholder=" <s:text name="review.vcode" />:" class="inputHeight" notnull=""
                                style="margin-right:0.3rem;width:36%" v-model.lazy.trim="submitObj.vCode">
                                <div class="form_code" style="width:32%">
                                    <img id="imgVcode" src="/servlet/verify.img" onclick="this.src=&quot;/servlet/verify.img?r=&quot;+Math.random();"
                                    style="cursor:pointer; width: 100%; height: 100%; object-fit: contain;">
                                </div>
                            </div>
                            <div>
                                <div>
                                    <input name="Submit" type="button" class="submit" id="sub_btn000" value="<s:text name="submit" />" @click="submit">
                                </div>
                            </div>
                    ...
                    <div class="main_right">
                        ...
                        <div class="main_rightB color666">
                            ...
                            <p>
                                <!-- TEL --><s:text name="Telephone" />：+86-577-85887585 <!-- Fax --><s:text name="fax" />：+86-577-89711316
                            </p>
                            <p>
        ...
        <script>
          var vm = new Vue({
              ...
              clickPdt(e){
                ...
                if( $(e.target).hasClass("close") ){
                  layer.open({
                    ...
                    ,yes: (index)=>{
                      layer.close(index);
                      axios.post('/home/pdt_PdtConsultPdtList_deletes',Qs.stringify({ids:currentTarget.data("goodsId")}))
                      .then((res) => {
                ...
                // 否则是选中 事件
                  ...
                  $(e.currentTarget).toggleClass("selected").siblings(".goods-item").removeClass("selected");
                }
              },
              ...
              submit(){
                ...
                if(  $(".choose-goods-list .goods-item.selected").length > 0 ){
                  if( this.imgsToUpload.length > 4 ){
                    this.submitObj.v.image = this.goodsList[goodsIndex].imgs.split(',')[0] + "," + this.imgsToUpload.slice(0,4).join(",");
                  }else if(this.imgsToUpload.length == 0){
                    this.submitObj.v.image = this.goodsList[goodsIndex].imgs.split(',')[0]
                  }else{
                    this.submitObj.v.image = this.goodsList[goodsIndex].imgs.split(',')[0] + "," + this.imgsToUpload.join(",");
                  }
                }else{
                  this.submitObj.v.image = this.imgsToUpload.join(",");
                }
                ...
                if (this.rq_mark){
                  ...
                  axios.post('/home/usr_UsrConsult_publish',Qs.stringify(this.submitObj, {allowDots: true}))
                  .then((res) => {
                    this.rq_mark=true;
                    ...
                    // 未登录时
                      ...
                      if( this.param_product_id != -1 ){
                        window.location.href='/home/usr_UsrPurchase_sign?jumpUrl=/home/usr_UsrConsult_publishView?product_id='+this.param_product_id;
                      }else{
            ...
            mounted(){
              ...
              // 获取商品列表
              this.submitObj.v.supplierId = getQueryString("supplierId") ? getQueryString("supplierId") : -1;
              axios.get('/home/pdt_PdtConsultPdtList_list',{params:{supplierId: this.submitObj.v.supplierId}})
              .then((res)=>{

...
public class CntArticle extends BeanInt<CntArticle> { // implements ICmbRpRpt{
  public static final Tb TB =
      new Tb(CntArticle.class, "文章管理").setAutoIncrement().addActIUDL().addActEnabled();
  ...
  public CntArticleCategory gtArticleCategory() {
    if (getArticleCategory() == null) return null;
  ...
  public void stArticleCategory(CntArticleCategory articleCategory) {
    if (articleCategory == null) setArticleCategory(null);
    else setArticleCategory(articleCategory.getPkey());
  }

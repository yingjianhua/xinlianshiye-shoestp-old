...
public class AddressView {
	...
	public static AddressView build(List<UsrPurchaseLine> addressList, Language lang) throws JSONException{
		AddressView view = new AddressView();
		for(UsrPurchaseLine address : addressList){
			if(Integer.valueOf(address.getIsdefault()).equals(Integer.valueOf(Sys.OYn.YES.getLine().getKey()))){

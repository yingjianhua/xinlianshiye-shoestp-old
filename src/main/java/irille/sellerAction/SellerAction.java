...
public abstract class SellerAction<THIS extends BeanMain> extends BeanAction<THIS>
  ...
  public static void main(String[] args) throws JSONException {
    ...
    System.out.println(json.has("en"));
  }
  ...
  public void exportGrid() throws Exception {
    ...
    ArrayList<ExportColumn> cols = new ArrayList<SellerAction.ExportColumn>();
    int rownum = 1; // 表头有几行
  ...
  public static final void setSupplier(UsrSupplier supplier) {
    ItpSessionmsg.getSessionmsg().setSupplier(supplier);
  }

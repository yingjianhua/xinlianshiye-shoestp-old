...
public class OrderMeetingProduct extends BeanInt<OrderMeetingProduct> {
  ...
  public static final Tb TB =
      new Tb(OrderMeetingProduct.class, "订购会-产品信息").setAutoIncrement().addActIUDL();
  ...
  public OrderMeetingProduct init() {
    ...
    _status =
        OrderMeetingProductStatus.DEFAULT
            .getLine()
            .getKey(); // 供应商认证 <OrderMeetingProductStatus>  BYTE
    _moq = 0; // 原起订量  INT
  ...
  public OrderMeetingProductStatus gtBillingstatus() {
    return (OrderMeetingProductStatus)
        (OrderMeetingProductStatus.OFF.getLine().get(_billingstatus));
  }

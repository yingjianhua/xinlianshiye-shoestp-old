...
public class OrderMeetingExhibition extends BeanInt<OrderMeetingExhibition> {
  ...
  public static final Tb TB =
      new Tb(OrderMeetingExhibition.class, "订购会-会场信息").setAutoIncrement().addActIUDL();
  ...
  public OrderMeetingExhibition init() {
    ...
    _status =
        OrderMeetingExhibitionStatus.DEFAULT
            .getLine()
            .getKey(); // 供应商场地 <OrderMeetingExhibitionStatus>  BYTE
  ...
  public OrderMeetingExhibitionStatus gtStatus() {
    return (OrderMeetingExhibitionStatus)
        (OrderMeetingExhibitionStatus.FAILED.getLine().get(_status));
  }

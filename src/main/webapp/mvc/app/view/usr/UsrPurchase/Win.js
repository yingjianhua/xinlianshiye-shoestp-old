Ext.define('mvc.view.usr.UsrPurchase.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.usr.UsrPurchase.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.usr.UsrPurchase.ListForm',{height : 300,border : false })
	}];
...
setActiveRecord : function(record){
		...
		if (record || this.form.activeRecord) {
			...
			this.lineTable.store.filter([{'id':'filter','property':'purchase','value':record.get('bean.pkey')}]);
		} else {

...
public class PltFreightSeller extends BeanInt<PltFreightSeller> {
	public static final Tb TB = new Tb(PltFreightSeller.class, "商家运费管理").setAutoIncrement().addActIUDL().addActEnabled();
	...
	public enum T implements IEnumFld {// @formatter:off
		...
		;
		public static final Index IDX_SUPPLIER_COMPANY = TB.addIndex("supplier_company", true, SUPPLIER, COMPANY);
  ...
  //方法----------------------------------------------
  public static PltFreightSeller loadUniqueSupplier_company(boolean lockFlag,Integer supplier,String company) {
    return (PltFreightSeller)loadUnique(T.IDX_SUPPLIER_COMPANY,lockFlag,supplier,company);
  }
  public static PltFreightSeller chkUniqueSupplier_company(boolean lockFlag,Integer supplier,String company) {

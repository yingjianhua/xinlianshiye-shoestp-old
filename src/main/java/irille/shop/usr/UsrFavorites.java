...
import irille.shop.usr.Usr.OJoinType;

public class UsrFavorites extends BeanInt<UsrFavorites>{
	
	public static final Tb TB = new Tb(UsrFavorites.class,"收藏夹").setAutoIncrement().addActList().addActDel().addActIns();
	...
	public enum T implements IEnumFld{
		...
		public static final Index IDX_PURCHASE_PRODUCT = TB.addIndex("purchase_product", true, PURCHASE,PRODUCT);
  ...
  //方法----------------------------------------------
  public static UsrFavorites loadUniquePurchase_product(boolean lockFlag,Integer purchase,Integer product) {
    return (UsrFavorites)loadUnique(T.IDX_PURCHASE_PRODUCT,lockFlag,purchase,product);
  }
  public static UsrFavorites chkUniquePurchase_product(boolean lockFlag,Integer purchase,Integer product) {

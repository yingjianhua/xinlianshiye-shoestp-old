...
public class RFQConsultGroupRelation extends BeanInt<RFQConsultGroupRelation> {
  ...
  private static final long serialVersionUID = 8684215113886966706L;

  public static final Tb<?> TB =
      new Tb<>(RFQConsultGroupRelation.class, "询盘分组关联表").setAutoIncrement();

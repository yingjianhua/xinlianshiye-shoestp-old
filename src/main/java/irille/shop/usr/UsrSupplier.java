...
public class UsrSupplier extends BeanInt<UsrSupplier> implements IExtName {
  ...
  public UsrSupplier init() {
    ...
    _companyIntroductionPageCustomDecorationOn =
        OYn.DEFAULT.getLine().getKey(); // 公司介绍页自定义装修开关 <OYn>  BYTE
  ...
  public SysUser gtApprBy() {
    if (getApprBy() == null) return null;
    return (SysUser) get(SysUser.class, getApprBy());
  }

  public void stApprBy(SysUser apprBy) {
    if (apprBy == null) setApprBy(null);
    else setApprBy(apprBy.getPkey());
  }
  ...
  public PltCountry gtBankCountry() {
    if (getBankCountry() == null) return null;
    return (PltCountry) get(PltCountry.class, getBankCountry());
  }

  public void stBankCountry(PltCountry bankCountry) {
    if (bankCountry == null) setBankCountry(null);
    else setBankCountry(bankCountry.getPkey());
  }
  ...
  public PltProvince gtBankProvince() {
    if (getBankProvince() == null) return null;
    return (PltProvince) get(PltProvince.class, getBankProvince());
  }

  public void stBankProvince(PltProvince bankProvince) {
    if (bankProvince == null) setBankProvince(null);
    else setBankProvince(bankProvince.getPkey());
  }
  ...
  public void setTotalEmployees(String totalEmployees, FldLanguage.Language l)
  ...
  public void setCompanyPhotoLink(String companyPhotoLink, FldLanguage.Language l)
      throws JSONException {
  ...
  public void setProductPageDiy(String productPageDiy, FldLanguage.Language l)
      throws JSONException {
  ...
  public void setContactPageDiy(String contactPageDiy, FldLanguage.Language l)
      throws JSONException {
  ...
  public void setCompanyIntroductionPageCustomDecoration(
      String companyIntroductionPageCustomDecoration) {
  ...
  public JSONObject gtCompanyIntroductionPageCustomDecoration() throws JSONException {
    return getCompanyIntroductionPageCustomDecoration() == null
        ? new JSONObject()
        : new JSONObject(getCompanyIntroductionPageCustomDecoration());
  }

  public void stCompanyIntroductionPageCustomDecoration(
      JSONObject companyIntroductionPageCustomDecoration) {
    setCompanyIntroductionPageCustomDecoration(
        companyIntroductionPageCustomDecoration == null
            ? null
            : companyIntroductionPageCustomDecoration.toString());
  }

  public String getCompanyIntroductionPageCustomDecoration(FldLanguage.Language l)
      throws JSONException {
    return gtCompanyIntroductionPageCustomDecoration().has(l.name())
        ? gtCompanyIntroductionPageCustomDecoration().getString(l.name())
        : "";
  }

  public void setCompanyIntroductionPageCustomDecoration(
      String companyIntroductionPageCustomDecoration, FldLanguage.Language l) throws JSONException {
    stCompanyIntroductionPageCustomDecoration(
        gtCompanyIntroductionPageCustomDecoration()
            .put(l.name(), companyIntroductionPageCustomDecoration));
  }
  ...
  public void setCompanyIntroductionPageCustomDecorationOn(
      Byte companyIntroductionPageCustomDecorationOn) {
  ...
  public void stCompanyIntroductionPageCustomDecorationOn(
      Boolean companyIntroductionPageCustomDecorationOn) {
    _companyIntroductionPageCustomDecorationOn =
        booleanToByte(companyIntroductionPageCustomDecorationOn);
  }

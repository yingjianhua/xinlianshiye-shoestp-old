...
public class Plt_Install extends InstallBase {
    ...
    private void initPltErate() {
        ...
        list.add(PltErateDAO.InsInit.build("", "USD", "$", true, true, BigDecimal.valueOf(1.0000), true, BigDecimal.valueOf(1.0000)));
        list.add(PltErateDAO.InsInit.build("", "EUR", "€", false, false, BigDecimal.valueOf(0.8010), false, BigDecimal.valueOf(0.8010)));
        list.add(PltErateDAO.InsInit.build("", "GBP", "￡", false, false, BigDecimal.valueOf(06330), false, BigDecimal.valueOf(0.6330)));
        list.add(PltErateDAO.InsInit.build("", "CAD", "CA$", false, false, BigDecimal.valueOf(1.1260), false, BigDecimal.valueOf(1.1260)));
        list.add(PltErateDAO.InsInit.build("", "AUD", "AU$", false, false, BigDecimal.valueOf(1.1650), false, BigDecimal.valueOf(1.1650)));
        list.add(PltErateDAO.InsInit.build("", "CHF", "CHF", false, false, BigDecimal.valueOf(0.9620), false, BigDecimal.valueOf(0.9620)));
        list.add(PltErateDAO.InsInit.build("", "HKD", "HK$", false, false, BigDecimal.valueOf(7.7520), false, BigDecimal.valueOf(7.7520)));
        list.add(PltErateDAO.InsInit.build("", "JPY", "￥", false, false, BigDecimal.valueOf(117.4750), false, BigDecimal.valueOf(117.4750)));
        list.add(PltErateDAO.InsInit.build("", "RUB", "p.", false, false, BigDecimal.valueOf(47.7350), false, BigDecimal.valueOf(47.7350)));
        list.add(PltErateDAO.InsInit.build("", "BRL", "R$", false, false, BigDecimal.valueOf(2.5036), false, BigDecimal.valueOf(2.5036)));
        list.add(PltErateDAO.InsInit.build("", "CLP", "$", false, false, BigDecimal.valueOf(599.1600), false, BigDecimal.valueOf(599.1600)));
        list.add(PltErateDAO.InsInit.build("", "NOK", "kr.", false, false, BigDecimal.valueOf(6.8741), false, BigDecimal.valueOf(6.8741)));
        list.add(PltErateDAO.InsInit.build("", "DKK", "kr.", false, false, BigDecimal.valueOf(5.9646), false, BigDecimal.valueOf(5.9646)));
        list.add(PltErateDAO.InsInit.build("", "SEK", "kr.", false, false, BigDecimal.valueOf(7.4184), false, BigDecimal.valueOf(7.4184)));
        list.add(PltErateDAO.InsInit.build("", "KRW", "₩", false, false, BigDecimal.valueOf(1099.4000), false, BigDecimal.valueOf(1099.4000)));
        list.add(PltErateDAO.InsInit.build("", "ILS", "₪", false, false, BigDecimal.valueOf(3.8784), false, BigDecimal.valueOf(3.8784)));
        list.add(PltErateDAO.InsInit.build("", "MXN", "$", false, false, BigDecimal.valueOf(13.7249), false, BigDecimal.valueOf(13.7249)));
        ins.setList(list);
        ins.commit();
    }

...
public class PdtAttrCat extends BeanInt<PdtAttrCat> implements IExtName {
	...
	public enum T implements IEnumFld { // @formatter:off
		PKEY(TB.crtIntPkey()), NAME(SYS.NAME__100, "名称"), // 名称
		DELETED(SYS.NY, "是否删除"), CREATE_BY(SYS.CREATED_BY), CREATE_TIME(SYS.CREATED_DATE_TIME),
		STATE(SYS.NY, "是否关闭关联属性名称"), ROW_VERSION(SYS.ROW_VERSION),

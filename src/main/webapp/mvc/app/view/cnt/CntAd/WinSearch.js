Ext.define('mvc.view.cnt.CntAd.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'CntAd_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
			...
			items : [{
					...
					items : [{
						...
						,{
							...
							,{xtype : 'numberfield',name : 'height',allowDecimals : false}
						...
						,{
							...
							,{xtype : 'numberfield',name : 'width',allowDecimals : false}

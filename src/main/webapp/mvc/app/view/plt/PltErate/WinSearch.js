Ext.define('mvc.view.plt.PltErate.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'PltErate_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
			...
			items : [{
					...
					items : [{
						...
						,{
							...
							,{xtype : 'numberfield',name : 'nowrate',decimalPrecision : 4}

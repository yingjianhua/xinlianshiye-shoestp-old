            ...
            <div class="wide">
                <div class="enterprise-info-wrap">
                    <h3 class="enterprise-info-title">
                        <s:text name="CompanyInformation" />
                    </h3>
                    <!-- 公司介绍 -->
                    <div class="company-introduction-wrap">
                        ...
                        <div class="summary">
                            ...
                            <div class="summary-text">
                                <p>
                                    <s:text name="LimitedLiabilityCompany" />
                                </p><!-- 企业类型 -->
                                <p>
                                    <s:text name="supplier.mainsalesarea" />: ${supView.mainSalesArea} </p>
                                <p>
                                    <s:text name="supplier.companytype" />: ${supView.companyType}</p>
                                <!-- MATERIALS -->
                            </div>

 ...
 */
public enum OrdrerMettingStatus implements IEnumOpt {
  ...
  public static final OrdrerMettingStatus DEFAULT = PENDING;
  private EnumLine _line;

  private OrdrerMettingStatus(int key, String name) {

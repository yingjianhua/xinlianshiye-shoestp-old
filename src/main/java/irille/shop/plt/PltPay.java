...
//        MAX_COST(SYS.PRICE, "最高价格限制"),
        ...
        public static final Index IDX_SUPPLIER_MODE = TB.addIndex("supplie_moder", false, SUPPLIER, MODE);
        private Fld _fld;
  ...
  public void setRowVersion(Short rowVersion){
    ...
    public enum OPay_Mode implements IEnumOpt {
        OFFINE_PAY(5, "线下支付"), TTPAY(10, "TT支付");
    ...
    public String toString() {
        return "PltPay{" +
                ...
                ", _supplier=" + _supplier +
                ", _poundage=" + _poundage +
                ", _extraCosts=" + _extraCosts +
                ", _enabled=" + _enabled +
                ", _paysetting='" + _paysetting + '\'' +

...
public class UsrConsultRelation extends BeanInt<UsrConsultRelation> {
	public static final Tb TB = new Tb(UsrConsultRelation.class, "询盘关联表")
			.setAutoIncrement();
	...
	public enum T implements IEnumFld {// @formatter:off
		...
		public static final Index IDX_CONSULT_SUPPLIER = TB.addIndex("consult_supplier", true,T.CONSULT, T.SUPPLIER);
		private Fld _fld;
  ...
  //方法----------------------------------------------
  public static UsrConsultRelation loadUniqueConsult_supplier(boolean lockFlag,Integer consult,Integer supplier) {
    return (UsrConsultRelation)loadUnique(T.IDX_CONSULT_SUPPLIER,lockFlag,consult,supplier);
  }
  public static UsrConsultRelation chkUniqueConsult_supplier(boolean lockFlag,Integer consult,Integer supplier) {

...
public class PageSearch extends Page {
    ...
    public PageSearch(int totalCount, int totalPage, int currentPage, int start, int limit, List items) {
    ...
    public PageSearch(Page searchPdtByQuery) {
        super(searchPdtByQuery.getTotalCount(), searchPdtByQuery.getTotalPage(), searchPdtByQuery.getCurrentPage(), searchPdtByQuery.getStart(), searchPdtByQuery.getLimit(), searchPdtByQuery.getItems());

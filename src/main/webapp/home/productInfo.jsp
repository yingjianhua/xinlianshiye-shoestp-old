...
<head>
    ...
    <link rel="stylesheet" href="/home/static/productInfo/css/reset.css"/>
    <script src='/home/static/productInfo/js/vue.min.js'></script>
    <!-- 引入样式 -->
    <link rel="stylesheet" href="https://unpkg.com/element-ui/lib/theme-chalk/index.css">
    <!-- 引入组件库 -->
    <script src="https://unpkg.com/element-ui/lib/index.js"></script>
    <script src="/home/static/productInfo/js/axios.min.js"></script>
    <script src="/home/static/productInfo/js/qs.js"></script>
    
     <%-- <link rel="stylesheet" href="/home/v3/static/css/reset1.css"/>
...
  
		...
		.shareTb{
			float:left;
			background:url(/home/static/productInfo/images/share_small.png) no-repeat;
			width:16px;
			height:16px;
			margin-top:9px;
			margin-left:5px;
		...
		<div class="clearfix">
					...
					<div class="flBox fl">
						<div style="position:relative;height:0;">
							<div class="hliketb flexCc" @click="addfav">
								<img src="/home/static/productInfo/images/hliketb1.png" alt="" v-show="!productinfocom.favorite"/>
								<img src="/home/static/productInfo/images/hliketb2.png" alt="" v-show="productinfocom.favorite"/>
							</div>
						</div>
					...
					<div class="frBox fr">
						<div class="h1">
							<div class="otowotb" v-if="productinfocom.type==4">
								<img src="/home/static/productInfo/images/icon-jinpai.png" alt="" />
								O2O
							</div>
							...
							<div class="sharebox fr">
								...
								<el-dropdown>
								  ...
								  <el-dropdown-menu slot="dropdown">
								    <div @click="shareThis('delicious')"><el-dropdown-item><a href="javascript:;" class="shareTb shareTbtb5"></a>delicious</el-dropdown-item></div>
								    <div @click="shareThis('digg')"><el-dropdown-item><a href="javascript:;" class="shareTb shareTbtb6"></a>digg</el-dropdown-item></div>
								    <div @click="shareThis('reddit')"><el-dropdown-item><a href="javascript:;" class="shareTb shareTbtb7"></a>reddit</el-dropdown-item></div>
								    <div @click="shareThis('stumbleupon')"><el-dropdown-item><a href="javascript:;" class="shareTb shareTbtb8"></a>stumbleupon</el-dropdown-item></div>
								    <div @click="shareThis('linkedin')"><el-dropdown-item><a href="javascript:;" class="shareTb shareTbtb9"></a>linkedin</el-dropdown-item></div>
								    <div @click="shareThis('vk')"><el-dropdown-item><a href="javascript:;" class="shareTb shareTbtb10"></a>vk</el-dropdown-item></div>
								  </el-dropdown-menu>
								</el-dropdown>
							</div>
						</div>
						
						<div class="h3">{{productinfocom.currency_unit}} {{productinfocom.currency_symbol}}{{price}}</div>
						...
						<div class="h5 clearfix">
							...
							<ul class="y2 fr clearfix">
								<li class="flexCc" :class="seleColorIndex==index?'sele':''"
									...
									<img class="hitb" src="/home/static/productInfo/images/icon-sele01.png" alt="" />
								</li>
							</ul>
						</div>
						...
						<div class="h5 clearfix">
							...
							<ul class="y3 fr clearfix">
								<li :class="seleSizeIndex==index?'sele':''" v-for="item,index in sizeList" @click="seleSizeli" :data-index = "index" :data-price = "item.price">
									{{item.size}}
									<img class="hitb" src="/home/static/productInfo/images/icon-sele01.png" alt="" />
								</li>
							</ul>
					...
					<div class="box2">
						...
						<div class="clearfix">
							<div class="fl" style="width:50%;" v-for="item,index in productinfocom.specifications">
								<div class="h2" style="font-size:16px;font-weight:bold;width:auto;padding-bottom:3px;">{{index}} :</div>&nbsp;&nbsp;
								<div class="h3" v-for="v in item" style="font-size:16px;">{{v}}</div>
							</div>
	                    </div>
                    </div>
					<div class="box">
						<div style="background-color: #dee2eb; width: 100%; height: 50px;" v-if="productinfocom.description != null && productinfocom.desModule.length>0">
			...
			<div class="fr">
				<div class="conpanyFrBox">
					...
					<div class="txt">
						<div class="h3"><img src="/home/static/productInfo/images/cn.png" alt="" />CN</div>
						<div class="h4">Shose</div>
						<div class="h5">
							<img class="mr4" src="/home/static/productInfo/images/icon-renzheng.png" alt="" />Certificate
							<div class="i"></div>
							<img class="mr4" src="/home/static/productInfo/images/icon-jinpai.png" alt="" />SVS
						</div>
						<div class="h6">
							<div>
					...
					<div class="hBtn"><img src="/home/static/productInfo/images/icon-youjian.png" alt="" />Contact Supplier</div>
					
					<a href="" class="h8">View Company Profile</a>

            ...
            <div class="cartBox" id="addressObj">
                ...
                <div class="contents address">
                        ...
                        <c:forEach items="${map.addressList}" var="address" varStatus="idx">
                            <li class="" style="display: list-item;">
                                <input type="radio" name="addressRadio"
                                       <c:if test="${address.isdefault == 1}">checked</c:if> value="${address.pkey}">
                                ...
                                <a href="javascript:;" class="edit_address_info" style="display:inline"
                                   id="${address.pkey}"><s:text name="Global.Edit"/></a>
                            </li>
                        </c:forEach>


                        <li style="display: list-item;">
                            <a id="addAddress" href="javascript:;" class="textbtn"><s:text
                                    name="Global.Add_New_Shipping_Address"/></a>
                        </li>
                        ...
                        <li id="addressForm" style="display: none;">
                            ...
                            <div class="editAddr">
                                <form id="setAddressId" method="post" action="">
                                    ...
                                    <a id="cancelAddr" class="cancel" href="javascript:;" style="display:;"><s:text
                                            name="Global.Cancel"/></a>
                                    <p>
                                    ...
                                    <table class="tb-shippingAddr">
                                        ...
                                        <tr>
                                            ...
                                            <td class="recipient">
                                                <div>
                                                    ...
                                                    <p>
                                                        <span class="required">*</span>&nbsp;<s:text
                                                            name="Global.First_Name"/></p>
                                                    <p class="errorInfo"></p>
                                                </div>
                                                <div>
                                                    <input type="text" name="bean.surname" maxlength="32"
                                                           class="elmbBlur">
                                                    <p>
                                                        <span class="required">*</span>&nbsp;<s:text
                                                            name="Global.Surname"/></p>
                                                    <p class="errorInfo"></p>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="bean.emailcode" maxlength="10"
                                                       class="elmbBlur">
                                                <p class="errorInfo"></p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                                <span class="required">*</span><label><s:text
                                                    name="Global.Country"/>:</label>
                                            </th>
                                            <td>
                                                ...
                                                <div id="country_chzn" class="chzn-container chzn-container-single"
                                                    ...
                                                    <div class="chzn-drop" style="left: -9000px; width: 308px;">
                                                        ...
                                                        <ul class="chzn-results">
                                                            <c:forEach items="${map.countries}" var="country">
                                                                <li class="group-option active-result"
                                                                    value="${country.pkey}"
                                                                    onclick="selectThisCountry(this)">${country.name}</li>
                                                            </c:forEach>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <tr id="zoneId">
                                            <th>
                                                <span class="required">*</span><label><s:text
                                                    name="Global.Province"/>:</label>
                                            </th>
                                            <td>

                                                <input id="sldProvinceHiden" type="hidden" name="bean.region"/>
                                                <div id="province_chzn" class="chzn-container chzn-container-single"
                                                     style="width:310px">
                                                    ...
                                                    <div class="chzn-drop" style="left: -9000px; width: 308px;">
                                                        ...
                                                        <c:forEach items="${map.countries}" var="country">
                                                            <ul class="chzn-results" id="getProvinces${country.pkey}"
                                                                style="display:none;">
                                                                <c:forEach items="${map.provinces}" var="province">
                                                                    <c:if test="${province.main == country.pkey}">
                                                                        <li class="group-option active-result"
                                                                            value="${province.pkey}"
                                                                            onclick="chooseThisProvice(this)">${province.name}</li>
                                                                    </c:if>
                                                                </c:forEach>
                                                            </ul>
                                                        </c:forEach>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input style="width:48px;" id="countryCode" class="left countryCode"
                                                       name="CountryCode" type="text" value="+0000" readonly="">
                                                <input id="addressId" type="hidden" name="bean.pkey"/>
                                                <div class="left editableSelect hasLayout">
                                                    <input type="text" name="bean.phonenumber" class="phoneNum elmbBlur"
                                                           maxlength="15" autocomplete="off">
                                                    <ul id="otherPhones"></ul>
                                                    <p class="errorInfo"></p>
                                                </div>
                                                <a href="javascript:void(0);" class="lightGray askTips"
                                                   title="We ask for your phone number just in case we need to reach you regarding your order."><s:text
                                                        name="user.whyAsk"/></a>
                                                <p id="phoneSample" class="lightGray clearfix"><s:text
                                                        name="Global.For_Example"/>: +
                                        ...
                                        <tr>
                                            <th></th>
                                            <td>
                                                <button id="useAddress" type="button" class="textbtn"><s:text
                                                        name="Global.Use_This_Shipping_Address"/></button>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div style="width: 30%;float: right;border-left: 1px dotted #ccc;margin-right: 39px;">
                        <p style="font-size: 17px;padding: 8px 8px;font-family: fantasy;"><s:text
                                name="cartcheckout.billing_Address"/></p>
            ...
            <form id="PlaceOrderFrom" method="post" action="" amountprice="" userprice="0" userratio="">
                    ...
                    <c:forEach items="${map.suppliers}" var="supplier" varStatus="index">
                        ...
                        <div class="cart-purchasing-station flex-center">
                            <div class="checkbox w_one tc"><s:text name="Shop"/>:</div>
                                ${supplier.name}
                            <input class="supplier" type="hidden" name="odrView[${index.index}].supplier"
                                   value="${supplier.id}"/>
                        </div>
                        <div class="cart-container">
                                                ...
                                                <div class="w_two flex-start">
                                                    ...
                                                    <div class="goods-descript">
                                                        <div class="goods-name">
                                                            <a target="_blank"
                                                               href="<c:if test="${product.type == 1}">/home/prm_PrmGroupPurchase_getGroupPdt?pkey=${product.line}</c:if><c:if test="${product.type == 0}">/home/pdt_PdtProduct_gtProductsInfo?id=${product.id}</c:if>">
                                                                    ${product.name}
                                                            </a>
                                                        </div>
                                                    ...
                                                    <c:if test="${color.proId == product.id}">
                                                        <div class="cart-list-item-detail-info-item flex-start">
                                                            ...
                                                            <div class="goods-spec-wrap">
                                                                <!-- 规格or颜色信息 -->
                                                                <div class="spec-or-color"><s:text
                                                                        name="Global.Colour"/>:${color.color}</div>
                                                                <!-- 同颜色下 不同型号的商品 item-list -->
                            ...
                            <div>
                                ...
                                <div class="remark" style="float:left;">
                                    ...
                                    <textarea name="odrView[${index.index}].remarks" id="supRemark_${supplier.id}"
                                              data="${supplier.id}" type="text"
                                              placeholder="<s:text name='Global.Remarks'/>"
                                              style="padding:0 10px;width: 27em;height: 5em;float: left;margin-left: 13px;"></textarea>
                                ...
                                <div class="item-total" style="float:right;">
                                    <p><s:text name="user.orderTotal"/>(
                                        <span>${supplier.qty}</span><s:text name="Global.Double"/>
                                        ): ${env.currency.symbols}
                            ...
                            <div class="cartBox" id="paymentObj">
                                ...
                                <div class="contents payment">
                                    ...
                                    <select name="odrView[${index.index}].payMethod" id="payMethod_${supplier.id}"
                                            data="${supplier.id}">
                                        <option value="-1">
                                        ...
                                        <c:forEach items="${map.payMethods[supplier.id]}" var="payMethod">
                                            <option value="${payMethod.id}" style="display: block;"><s:text
                                                    name="pay.mode.%{#attr.payMethod.mode}"/></option>
                                        </c:forEach>
                                    </select>
                            ...
                            <div class="cartBox" id="express">
                                ...
                                <div class="contents payment">
                                    <h3 style="font-size: 14px;font-weight: bold;line-height: 30px;display: block;">
                                        <s:text name="Global.Delivery_Method"/>:</h3>
                                    <select name="odrView[${index.index}].express" id="express_${supplier.id}"
                                            data="${supplier.id}">
                                        <option value="-1">
                            ...
                            <div>
                                <div class="NoteBox" style="float: left;margin-top: 0;">
                                    <h2 style="float: left;display: block;height: 38px;font: 400 16px/38px georgia;color: #990000;zoom: 1;text-indent: 12px;margin: 0 13px 0 0;">
                                        <s:text name="Order_Note_Content"/></h2>
                                    <div class="notes">
                                        <textarea plecaholder="<s:text name="Order_Note_Content"/>"
                                                  id="odrRemarks_${supplier.id}"
                                                  name="odrView[${index.index}].odrRemarks"></textarea>
                                    </div>
                                </div>
                                ...
                                <table style="width: 36%;float: right;">
                                    ...
                                    <tr style="width: 100%;border-top: 1px dotted #ccc;">
                                        <td style="width: 86.5%;text-align: right;padding: 10px;">
                                            <input value="Free Shipping" name="shippingMent"
                                                   style="position: relative;top: 2px;left: -6px;" type="radio"
                                                   checked="checked"><s:text name="product.is_free_shipping"/>:
                                        </td>
                ...
                <div class="CartAmountSum">
                    ...
                    <fieldset id="submitCart" class="clearfix" style="display: block;">
                        <button type="button" id="orderSubmit" class="fr litb-btn placeOrderBtn"><s:text
                                name="Place_Your_Order"/></button>
                        <p class="clearfix"><s:text
                                name="Global.Every_Order_You_Place_With_Us_Is_Safe_And_Reliable"/></p>
                    </fieldset>
                </div>

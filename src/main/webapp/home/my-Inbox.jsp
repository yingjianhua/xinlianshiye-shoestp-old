        ...
        <div id="lib_user_main">
            ...
            <div id="lib_user_inbox" class="clearfix" type="outbox">
                <div class="inbox_menu">
                    <ul class="menu_title">
                        <li><a href="javascript:void(0);" hidefocus="true" class="current"><s:text name="my-Inbox.Inbox"/></a></li>
                        <li><a href="javascript:void(0);" hidefocus="true"><s:text name="my-Inbox.Outbox"/></a></li>
                        <li><a href="javascript:void(0);" hidefocus="true" class=""><s:text name="my-Inbox.Write_Pieces"/></a></li>
                        <li><a href="javascript:void(0);" hidefocus="true" class="hide"><s:text name="my-Inbox.Read_Inbox"/></a></li>
                        <li><a href="javascript:void(0);" hidefocus="true" class="hide"><s:text name="my-Inbox.Reply_Inbox"/></a></li>
                    </ul>
                    <div class="menu_content">
                        ...
                        <div class="menu inbox_form hide">
                            ...
                            <div class="rows">
                                <label></label>
                                <span class="input">
							<input type="button" class="submit_btn" id="submit_button" value="<s:text name='send_Out'/>">
						</span>
                            </div>
                        </div>
                        ...
                        <div class="menu inbox_form hide" id="reply">
                            ...
                            <input type="button" class="submit_btn" id="ButtonReply" value="<s:text name='my-Inbox.Reply'/>">
                        </div>
                    </div>
                </div>
            </div>

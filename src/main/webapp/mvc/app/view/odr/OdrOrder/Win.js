Ext.define('mvc.view.odr.OdrOrder.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.odr.OdrOrder.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.odr.OdrOrder.ListForm',{height : 300,border : false })
	}];

Ext.define('mvc.view.cnt.CntSglPage.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'CntSglPage_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
			...
			items : [{
					...
					items : [{
						...
						,{
							...
							,
								mvc.Tools.crtComboTrigger(true,'cnt_CntSglPageCategory','',{
											name : 'pageType'
										})

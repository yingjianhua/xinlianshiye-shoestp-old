Ext.define('mvc.view.prm.PrmGroupOrder.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'PrmGroupOrder_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
			...
			items : [{
					...
					items : [{
						...
						,{
								...
								mvc.Tools.crtComboBase(false,{
											name : 'optcht_activity',
											width : 80,
											value : 3,
											store : outstore
										})
							,
								mvc.Tools.crtComboTrigger(true,'prm_PrmGroupPurchase','',{
											name : 'activity'
										})
						...
						,{
								...
								mvc.Tools.crtComboBase(false,{
											name : 'optcht_productnum',
											width : 80,
											value : 3,
											store : numstore
										})
							,{xtype : 'numberfield',name : 'productnum',allowDecimals : false}

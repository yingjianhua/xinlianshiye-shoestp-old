...
public class BatchUtils {
  ...
  public static <T extends Bean> void batchIns(
      Class<T> beanClass, List<IEnumFld> flds, List<T> objs) {
  ...
  public static <T extends Bean> void batchDel(
      Class<T> beanClass, List<IEnumFld> flds, List<T> objs) {
    StringBuffer sql = new StringBuffer();
  ...
  public static <T extends Bean> void batchUpd(
      Class<T> beanClass, List<IEnumFld> flds, List<IEnumFld> whereFlds, List<T> objs) {
    StringBuffer sql = new StringBuffer();
    sql.append(" UPDATE ");
    sql.append(Tb.getTBByBean(beanClass).getCodeSqlTb());
    sql.append(" SET ");

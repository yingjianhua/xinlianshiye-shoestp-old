Ext.define('mvc.view.cnt.CntAd.List',{
...
mainActs.push({
		...
		items : [{
				xtype : Ext.create('mvc.view.cnt.CntAd.ListMain',{
							title : '广告管理',
				...
				xtype : Ext.create('mvc.view.cnt.CntAd.ListLineCntAdLine',{
							title : '广告明细',
...
onIns : function(){
		var win = Ext.create('mvc.view.cnt.CntAd.Win',{
			title : this.title+'>新增'
		});
		...
		if (selection){
			...
			Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg, 
				function(btn) {
					...
					Ext.Ajax.request({
						url : base_path+'/cnt_CntAd_delMulti?pkeys='+arr.toString()+'&rowVersions='+arrv.toString(),
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.cnt.CntAd.WinSearch',{

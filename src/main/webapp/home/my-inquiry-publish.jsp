            ...
            <div id="lib_user_crumb" class="widget">
                <ul class="crumb_box clearfix">
                    ...
                    <li class="crumb2 root">
                        <a href="/home/usr_UsrConsult_publishView" title="My Inquiry/RFQ"><s:text name="my-inquiry-publish.View_Inquiry"/>
                            <i></i>
                        </a>
                    </li>
                </ul>
                ...
                <div id="lib_user_msg" class="clearfix">
                  ...
                  <div class="main_left">
                    <header>
                      ...
                      <div>
                        ...
                        <p style="font-size:14px;color: #666;"><s:text name="Global.One_Request"/></p>
                      </div>
                    </header>
                    <div>
                      <h1 class="header-title1"><s:text name="my-inquiry-publish.Tell_The_Supplier_What_You_Need"/></h1>
                      <p class="font-bold" style="margin-bottom:10px;font-size: 18px;"><s:text name="my-inquiry-publish.Complete_Your_Inquiry"/></p>
                      <p style="font-size:14px;color: #666;"><s:text name="my-inquiry-publish.Information_Specific"/></p>
                    </div>
                    <form action="" method="post" enctype="multipart/form-data" id="inquiry_form">
                      <div class="form_header marginBottom flex">
                        ...
                        <input type="button" class="inputHeight btn-white-gradient btn-select-pdt" value="<s:text name='my-inquiry-publish.Select_Product'/>">
                      </div>


                      <div class="form_header marginBottom">
                        <div class="input-wrap marginRight required" style="width: 40%;">
                          <input type="text" placeholder=" <s:text name='Global.Name'/>" class="inputHeight"
                            notnull=""
                            v-model.lazy.trim="submitObj.v.name">
                        </div>
                        <div class="input-wrap required" style="width: 40%;">
                          <input type="email" placeholder=" <s:text name='Global.Email'/>" id="email"
                      ...
                      <div class="form_header marginBottom">
                        <div class="input-wrap required">
                          <select name="Country" notnull="" class="inputHeight"
                            ...
                            <option value="undefined">---<s:text name="Global.Please_Choose"/>---</option>
                      ...
                      <div class="form_main marginBottom">
                        ...
                        <div class="chooseImgWrap clearfix">
                          <div class="fl" style="width: 90px;height: 90px; margin-right: 8px;" v-if="selectGoodsIndex != -1">
                            <img :src="'${envConfig.imageBaseUrl}'+goodsList[selectGoodsIndex].imgs.split(',')[0]" style="width: 100%;height: 100%;object-fit: contain;">
                          </div>
                          ...
                          <div class="chooseImg fl">
                            <el-upload
                              ...
                              <img src="./static/images/upImg.png" style="width: 100%;height: 100%;object-fit: contain;">
                            </el-upload>
                          </div>
                        </div>
                      ...
                      <div class="form_footer marginBottom">
                        <div class="input-wrap required marginRight" style="width: 40%;">
                          <input type="text" placeholder=" <s:text name='my-inquiry-publish.Input_Quantity'/>" class="inputHeight"
                            notnull="" name="Subject"
                            v-model.lazy.trim.number="submitObj.v.quantity">
                        </div>
                        <div class="input-wrap required marginRight" style="width: 40%;">
                          <input type="text" placeholder=" <s:text name='Global.Verification_Code'/>" class="inputHeight"
                            notnull=""
                            v-model.lazy.trim="submitObj.vCode">
                        </div>
                        <div class="form_code">
                          <img src="/servlet/verify.img" onclick="this.src=&quot;/servlet/verify.img?r=&quot;+Math.random();"
                            id="imgVcode"
                      ...
                      <div>
                        <div>
                          <input type="button" :disabled="flag" value="<s:text name='my-inquiry-publish.Submit_Inquiry'/>" class="submit" @click="submit">
                        </div>
                      </div>
                    </form>
                    <div class="footer">
                      <div>
                        <h3 class="header-title2"><s:text name="my-inquiry-publish.How_Fast"/></h3>
                        <div>
                          <span><s:text name="my-inquiry-publish.Submit_Inquiry"/></span> → <span><s:text name="compareQuotes"/></span> → <span><s:text name="my-inquiry-dialog.Contact_Supplier"/></span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="main_right">
                    <div class="main_rightT">
                      <h3 class="header-title2" style="margin-top:0"><s:text name="my-inquiry-publish.About_Publishing"/></h3>
                    ...
                    <div class="main_rightB">
                      ...
                      <p><s:text name="Global.Phone"/>：+86-577-85887585 <s:text name="Global.Fax"/>：+86-577-89711316</p>
                    ...
                    <s:text name="my-inquiry-publish.Improve_Inquiry"/>
                     <!--  <p>Attachments like product</p>
                      ...
                      <div class="pop-frame pop-frame-select-goods">
                        ...
                        <div class="pop-frame-content flex-start">
                          <div class="goods-list">
                            <div class="goods-item"
                              ...
                              @click="clickPdt"
                              >
                              <img class="btn-goods-delete" :data-goods-id="goods.id" src="./static/images/ico/del.png">
                              <div class="goods-pic">
                        ...
                        <div class="pop-frame-footer">
                          <label for="use-title" class="fl">
                            ...
                            <span><s:text name="my-inquiry-publish.Use_Product_Name_As_Title"/></span>
                          </label>
                          <div class="btn btn-red btn-confirm" @click="submitSelectedGoods"><s:text name='Global.Submit'/></div>
                      ...
                      <div class="pop-frame pop-frame-delete-product pop-small" style="display:none">
                        ...
                        <div class="pop-frame-content flex-start" style="padding: 15px;text-align: center;">
                          Are you sure?
                        </div>
    ...
    var vm = new Vue({
        ...
        methods:{
          ...
          submit(){
            ...
            let goodsIndex = $(".pop-frame-select-goods .goods-item.selected").data("goodsIndex"); //获取选中的商品所在list的下标

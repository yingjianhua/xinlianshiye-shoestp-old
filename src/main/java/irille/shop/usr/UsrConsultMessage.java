...
public class UsrConsultMessage extends BeanInt<UsrConsultMessage> {
  public static final Tb TB =
      new Tb(UsrConsultMessage.class, "询盘留言").setAutoIncrement().addActIUDL();

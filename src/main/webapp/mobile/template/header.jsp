                                        ...
                                        <s:if test="#cat2.subs.size()>0">
                                            ...
                                            <ul class="menu_son menu_grandson">
                                                <s:iterator value="subs" var="cat3">
                                                    <li class="item">
                                                        <a href="/home/pdt_PdtProduct?cated=${cat3.id }"
                                                           title="${cat3.name }">
                                                                ${cat3.name }
                                                        </a>
                                                    </li>
        ...
        <div class="pop_up_container clean">
            ...
            <div class="menu_list">
                <s:iterator value="env.currencys" var="currency">
                    <div class="item">
                        <a href="javascript:;" data="${currency.id }"><img
                                src="${envConfig.imageBaseUrl}${currency.img }"
                                alt="${currency.shortName }">${currency.shortName }</a>
                    </div>
                </s:iterator>
            </div>
        </div>

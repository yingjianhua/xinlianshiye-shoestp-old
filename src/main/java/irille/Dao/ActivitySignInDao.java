...
/** Created by IntelliJ IDEA. User: lijie@shoestp.cn Date: 2018/11/20 Time: 13:51 */
public class ActivitySignInDao {
  ...
  public Page getAllSignInInfo(int start, int limit, int country, String keyword) {
    ...
    List list =
        query.SELECT(ActivityInfo.class).FROM(ActivityInfo.class).queryList(ActivityInfo.class);

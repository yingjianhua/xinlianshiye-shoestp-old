...
<head>
    ...
    <link rel="stylesheet" href="./static/css/xl-style.css">
    <link href="./static/css/stp.css" rel="stylesheet" type="text/css">
                ...
                <c:forEach var="d" items="${purchaseIndexView.headedRightTopAds}">
                    <h1>
                        <a target="_blank" href="${d.url}">
                            <img src="${d.image}" width="380" height="212"
                                 alt="${d.name}"> </a>
                    </h1>
                </c:forEach>
                <h1>
                    ...
                    <c:forEach var="d" items="${purchaseIndexView.headedBottomTopAds}">
                        <a href="${d.url}">
                            <img src=${d.image} alt="" width="${380/fn:length(purchaseIndexView.headedBottomTopAds)}"
                                 height="170" border="0"
                            >
                        </a>
                        <%--<map name="Map">--%>
    ...
    <c:forEach items="${purchaseIndexView.pdtCategoryAds}" var="d" varStatus="status">
        <div class="xl-banner">
            ...
            <ul class="women_ul clearfloat">
                <li>
                    <a href="/home/pdt_PdtProduct?cated=${d.pkey}" target="_blank">More+</a>
                </li>
                        ...
                        <ul class="toys_ul">
                            <c:forEach var="dd" items="${d.ads.items}">
                                <li>
                                    <a target="_blank"
                                       href="${dd.url}">
                                        <img class="lazy" src="${dd.image}"
                                             data-original="${dd.pkey}"
        ...
        <div id="xl-banner_four">
            ...
            <div class="new_product">
                <div class="clearfloat" style="padding:0 15px 0 0;">
                    ...
                    <span class="more">
							<!--                                更多按钮-->
							<a href="/home/pdt_PdtProduct?orderfld=New" target="_blank">More+</a>
						</span>
                </div>
                    ...
                    <div class="cata-box">
                        <ul class="toys_ul product_ul_list clearfloat">
                            <c:forEach items="${purchaseIndexView.newProducts}" var="d" step="1">
                                <li>
                                    <a href="/home/pdt_PdtProduct_gtProductsInfo?id=${d.pkey}"
                                       title="${d.name}"
                                       target="_blank">
                                        <img class="lazy" src="${d.picture}"
                                             data-original="${d.picture}" width="230"
            ...
            <div class="brand">
                <div class="clearfloat" style="padding:0 15px 0 0;">
						...
						<span class="toptic_title">
							<!--                                品牌展示-->
							<a class="BrandShow" target="_blank" href="/home/usr_UsrSupplier">Brand Show</a>
						</span>
                    <span class="more">
							<!--                                更多按钮-->
							<a href="/home/usr_UsrSupplier" target="_blank">More+</a>
						</span>
                </div>

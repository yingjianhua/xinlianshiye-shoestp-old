...
public class PltCountryFreightAction extends SellerAction<PltCountryFreight> implements IPltCountryFreightAction {
	...
	public  void list () throws Exception{
		...
		for (PltCountryFreight line : list) {
			...
			lineJson.put("countrys",line.gtCountry().getName(PltConfigDAO.supplierLanguage(SellerAction.getSupplier())));
			ja.put(lineJson);
		}

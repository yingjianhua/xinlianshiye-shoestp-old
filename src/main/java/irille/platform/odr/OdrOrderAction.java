...
public class OdrOrderAction extends ActionBase<OdrOrder> {
  ...
  @Getter @Setter private String orderNum; // 订单号
  @Getter @Setter private Integer state; // 订单状态

  /** @Description: 获取订单列表 *@date 2019/1/22 11:18 *@anthor zjl */
  public void getOrders() throws IOException {
    write(OdrOrderDAO.getOrders(getStart(), getLimit(), orderNum, state));
  }

  /** @Description: 获取订单有关的所有状态 *@date 2019/1/22 14:59 *@anthor zjl */

Ext.define('mvc.view.prm.PrmGroupPurchase.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.prm.PrmGroupPurchase.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.prm.PrmGroupPurchase.ListForm',{height : 300,border : false })
	}];

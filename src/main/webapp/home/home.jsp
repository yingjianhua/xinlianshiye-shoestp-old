        ...
        <div class="ljxcon-1">
            <div class="ljxcon">
                ...
                <div class="ljxhidden" style="padding-top: 68px;">
                    ...
                    <a href="/home/pdt_PdtProduct?cated=373"><span><s:text name="Learn_More"/></span></a>
                </div>
            </div>
            <div class="ljxcon">
                <div class="ljxshow">
                ...
                <div class="ljxhidden" style="padding-top: 68px;">
                    ...
                    <a href="/home/pdt_PdtProduct?cated=380"><span><s:text name="Learn_More"/></span></a>
                </div>
            </div>
            <div class="ljxcon">
                <div class="ljxshow">
                ...
                <div class="ljxhidden" style="padding-top: 68px;">
                    ...
                    <a href="/home/pdt_PdtProduct?cated=387"><span><s:text name="Learn_More"/></span></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="goods-category-item stop-swiping">
                <div class="flex-left-right">
                    <div class="descript-box">
                        ...
                        <a href="/home/Activity_Romania" target="_blank" class="btn-see-all"><s:text
                                name="See_All"/></a>
                    </div>
                                    ...
                                    <li class="item" v-for="(goods, index) in manShoesList" v-if="index < 4">
                                        ...
                                        <div class="hover-show">
                                            <div class="hover-text-wrap">
                                                ...
                                                <div class="tips" v-if="goods.min_order > 0"><s:text name="Min_order"/>:
...
<span class="tip-title fl"><s:text name="Free_Alerts_on_newly_added_products"/></span>
<input type="email" v-model="form.email" class="tip-input fl" placeholder="<s:text name='Example'/>:jsun@company.com"/>
    <!-- {{bean.email}} -->
    ...
    <p style="font-size: 18px;color: #c3c3c3;line-height: 50px"><s:text name="SHOES"/></p>
    <p style="font-size: 24px;color: #ffffff;line-height: 25px;width: 250px"><s:text name="AN_EASY_WAY_TO_SEND_BUYING_REQUESTS_TO_SUPPLIERS_GET_QUOTES_QUICKLY"/></p>
    ...
    <span style="display:inline-block;width: 39%;height: 44px;border: 1px solid #c4c4c4;margin: 10px 0;text-indent: 10px;margin-left:-5px;font-size: 16px;line-height: 42px;color: #a1a1a1;"><s:text
            name='Bag_Bags'/></span>
    <p style="font-size: 16px;line-height: 42px;color: #a1a1a1;"><s:text name='Select_template_type'/></p>
    ...
    <div><s:text name="Min_order"/>:{{item.min_order}} <s:text name="pairs"/></div>
    </div>
    </a>
    ...
    <div class="clearfix">
    <a href="/home/pdt_PdtProduct" target="_blank" class="blueFontColor fr"><s:text name="See_All_Products"/></a>
    </div>
    </div>
    <!-- CROWDFUNDING -->
    ...
    <span style="color:#808080;font-size: 14px;"><s:text name="Remaining"/>1 <s:text name="days"/></span>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="goods-time">
    <img src="/home/v2/static/images/home/icon-time.png" alt="">
    <span style="color:#808080;font-size: 14px;">1 <s:text name="Days_left"/></span>
    </div>
    </div>
    </div>
    </div>

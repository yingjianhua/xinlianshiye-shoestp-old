...
public class Regular {
  ...
  public static final String REGULAR_ENG = "[A-Za-z]{0,}"; // 英文字符校验
  ...
  // 长度限制为180 数据库长度为200
  public static final String REGULAR_CHINATEL =
      "^((1\\d{10})|(\\d{4}-?\\d{8}))$"; // 国内手机/电话校验 格式 138111111111
  // 0511-11111111
  // 051111111111
  ...
  public static final String REGULAR_COMPANY =
      "^([^`~!@#$%^&*()+= -\\]\\[';/.,<>?:\"{}|]).{0,52}(?<![`~!@#$%^&*()+= -\\]\\[';/.,<>?:\"{}|])$"; // 公司名字校验

  public static String REGULAR_WEBSITE =
      "^http[s]?:\\/\\/[\\w]{1,}.?[\\w]{1,}.?[\\w/.?&=-]{1,}$"; // 公司网址校验
  // 请输入完整网址格式，如https://www.shoestp.com

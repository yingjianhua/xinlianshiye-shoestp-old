 ...
 */
public class RFQ_MessageBody extends BeanInt<RFQ_MessageBody> {

    public static final Tb TB = new Tb(RFQ_MessageBody.class, "RFQ_站内信消息主体").setAutoIncrement();

    public enum T implements IEnumFld {
        PKEY(TB.crtIntPkey()),
        MESSAGE_TITLE(RFQ_Messages.fldOutKey()),
        ROOT_ID(RFQ_MessageBody.fldOutKey().setNull()),
        MESSAGE_BODY(SYS.JSON),
    ...
    public void stActivityCat(PdtCat activityCat) {
        if (activityCat == null)
            ...
            setActivityCat(activityCat.getPkey());
    }

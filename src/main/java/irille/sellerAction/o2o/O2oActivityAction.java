...
public class O2oActivityAction extends SellerAction<O2O_Activity> implements IO2oActivityAction {
  ...
  @Inject private IO2OPdtServer o2oPdtServer;

  @Inject private IO2OActicityServer o2oActicityServer;
  ...
  @Setter private Integer countryId;
  @Setter private Integer id;
  @Setter private Integer status;
  @Setter private String name;
  @Setter private String tel;
  @Setter private String pdts;
  @Setter private String reason;

  @Setter private int isMyjoin;

  /** 获取活动列表 当isMyJoin为0时获取所有活动 否则获取当前登录用户参加的活动 */
  public void getActivityList() throws IOException {
    ...
    write(
        o2oPdtServer.getO2OActivityList(
            getSupplier(),
            getStart(),
            getLimit(),
            startDate,

Ext.define('mvc.view.cnt.CntAd.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.cnt.CntAd.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.cnt.CntAd.ListForm',{height : 300,border : false })
	}];

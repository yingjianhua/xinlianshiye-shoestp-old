                ...
                <c:forEach items="${map.suppliers}" var="supplier" varStatus="index">
                    ...
                    <div class="cart-purchasing-station flex-center">
                        <div class="checkbox w_one tc"><s:text name="Shop"/>:</div>
                            ${supplier.name}
                        <input class="supplier" type="hidden" name="list[${index.index}].supplierid"
                               value="${supplier.id}"/>
                    </div>
                    <div class="cart-container">
                                                                ...
                                                                <c:forEach items="${map.specs}" var="spec"
                                                                    ...
                                                                    <c:if test="${spec.colorId == color.id && spec.productId == product.id}">
                                                                        ...
                                                                        <input type="hidden" value="${spec.id}"
                                                                               name="list[${index.index}].list[${specNums}].id"/>
                                                                        <div class="color-goods-item flex-center">
                                                                            ...
                                                                            <div class="goods-num flex-center w_four">
                                                                                <input type="hidden" value="${spec.qty}"
                                                                                       name="list[${index.index}].list[${specNums}].num"/>
                                                                                    ${spec.qty}
                                                                            </div>
                                                                            <!-- 单个商品总价 -->
                        ...
                        <div>
                            ...
                            <div class="remark" style="float:left;">
                                ...
                                <textarea name="list[${index.index}].remarks" id="supRemark_${supplier.id}"
...
<script type="text/javascript">
    ...
    $("#orderSubmit").on("click", function () {
        ...
        $.ajax({
            url: '/home/easy_EasyOdr_generateOrder',
            type: 'post',

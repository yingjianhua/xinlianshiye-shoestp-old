Ext.define('mvc.view.plt.PltCountry.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.plt.PltCountry.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.plt.PltCountry.ListForm',{height : 300,border : false })
	}];

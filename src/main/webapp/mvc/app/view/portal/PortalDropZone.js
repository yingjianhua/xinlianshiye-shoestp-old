/**
 * @class mvc.view.portal.PortalDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link mvc.view.portal.PortalPanel}.
 */
Ext.define('mvc.view.portal.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        mvc.view.portal.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        mvc.view.portal.PortalDropZone.superclass.unreg.call(this);
    }
});

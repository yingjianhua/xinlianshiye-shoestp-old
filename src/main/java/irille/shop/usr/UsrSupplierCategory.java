...
public class UsrSupplierCategory extends BeanInt<UsrSupplierCategory> implements IExtName {
  public static final Tb TB =
      new Tb(UsrSupplierCategory.class, "供应商分类").setAutoIncrement().addActIUDL();
  ...
  public String toString() {
    return "UsrSupplierCategory [_pkey="
        + _pkey
        + ", _name="
        + _name
        + ", _showName="
  ...
  public UsrSupplierCategory gtCategoryUp() {
    if (getCategoryUp() == null) return null;
  ...
  public void stCategoryUp(UsrSupplierCategory categoryUp) {
    if (categoryUp == null) setCategoryUp(null);
    else setCategoryUp(categoryUp.getPkey());
  }

Ext.define('mvc.view.cnt.CntSglPageCategory.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'CntSglPageCategory_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
			...
			items : [{
					...
					items : [{
								...
								mvc.Tools.crtComboBase(false,{
											name : 'optcht_pageName',
											width : 80,
											value : 1,
											store : strstore
										})
							,{xtype : 'textfield',name : 'pageName'}
						...
						,{
								...
								mvc.Tools.crtComboBase(false,{
											name : 'optcht_pageTypeText',
											width : 80,
											value : 1,
											store : strstore
										})
							,{xtype : 'textfield',name : 'pageTypeText'}

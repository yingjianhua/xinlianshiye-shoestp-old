Ext.define('mvc.view.easy.EasyOdr.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.easy.EasyOdr.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.easy.EasyOdr.ListForm',{height : 300,border : false })
	}];

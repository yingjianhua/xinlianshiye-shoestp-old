                ...
                <form method="post" class="user_login_form" id="login_form">
                    <div class="user_login_box">
                        ...
                        <div class="user_input user_password">
                            <div class="ui_border_b">
                                <input type="password" name="password" autocomplete="off" placeholder="<s:text name='Enter_Your_Password'/>"
                                notnull="">
                            </div>
                        </div>
                        <div class="user_input user_password" id="w_login_vcode" style="display:none;">
                            <div class="ui_border_b clean">
                                ...
                                <div class="fl" style="height:2.1875rem; line-height:2.1875rem; width:45%; margin-left:1%;">
                                    <img src="/servlet/verify.img" onclick="this.src=&quot;/servlet/verify.img?r=&quot;+Math.random();" style="cursor:pointer;">
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- </div> -->
                    <input type="hidden" name="jumpUrl" value="<s:if test="jumpUrl==null">/</s:if><s:else>${jumpUrl }</s:else>">
                ...
                class="user_login_form" id="reg_form">
                    ...
                    <div class="rows">
                        ...
                        <div class="input clean">
                            ...
                            placeholder="<s:text name='Purchase_sign_up_pwd'/>" data-field="<s:text name='account.password'/>" notnull="">
                            <p class="error">
                            </p>
                        </div>
                    </div>
                    <div class="rows">
                        ...
                        <div class="input clean">
                            ...
                            placeholder="<s:text name="Global.Confirm_Password" />" data-field="<s:text name='Global.Confirm_Password'/>" notnull="">
                            <p class="error">
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="box_select">
                             <select name="country_id" autocomplete="off">
                            	<s:iterator value="countrys" var="line">
                            		<option value="${line.id}" <s:if test="#line.isDefault==1">selected="selected"</s:if>>${line.name }</option>
								</s:iterator>
							</select>
                            </div>
                        </div>
                    ...
                    <div class="rows">
                        <div class="form_name form_code clean">
                            <div class="box" id="demo_default">
                                ...
                                <input name="checkCode" class="box_input" type="text" size="10" maxlength="4" data-field="<s:text name='Global.Verification_Code'/>" notnull="">
                                <p class="error">
                                </p>
                            </div>
                            <div class="box">

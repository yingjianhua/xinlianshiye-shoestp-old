...
public class CacheUtils {
	...
	public static LoadingCache<Integer, JsonObject> colorCache = CacheBuilder.newBuilder()
			.expireAfterAccess(12, TimeUnit.HOURS).maximumSize(1000).build(new CacheLoader<Integer, JsonObject>() {
				@Override
	...
	public static LoadingCache<Integer, JsonObject> sizeCache = CacheBuilder.newBuilder()
			.expireAfterAccess(12, TimeUnit.HOURS).maximumSize(1000).build(new CacheLoader<Integer, JsonObject>() {
				@Override
				public JsonObject load(Integer s) throws Exception {
	 ...
	 * @author chen
	 */
	public static Cache mailValid = Caffeine.newBuilder().expireAfterAccess(24, TimeUnit.HOURS).build();
	 ...
	 * @author chen
	 */
	public static Cache pwdValid = Caffeine.newBuilder().expireAfterAccess(15, TimeUnit.MINUTES).build();
	/**

            ...
            <div class="top_mem fr">
                <div class="mendiv">
                	<s:if test="env.login==null">
	                    <a rel="nofollow" href="javascript:;" class="SignInButton FontColor"><s:text name="web-top.LogIn" /></a> <s:text name="web-top.Or" />
	                    <a rel="nofollow" href="/home/usr_UsrPurchase_sign" class="FontColor"><s:text name="web-top.Registered" /></a>
                	</s:if>
                	<s:else>
										...
										<div class="user-drop-wrap">
											...
											<dl class="fl list">
												<dd class="user">
													...
													<a rel="nofollow" href="/home/usr_UsrFavorites_myfavorite"><s:text name="Global.My_Favorites" /></a>
													...
													<a rel="nofollow" href="/home/usr_UsrPurchase_signOut"><s:text name="Global.Drop_Out" /></a>
												</dd>
											</dl>
										</div>
                	</s:else>

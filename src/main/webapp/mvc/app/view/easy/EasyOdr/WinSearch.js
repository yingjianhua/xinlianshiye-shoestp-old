Ext.define('mvc.view.easy.EasyOdr.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'EasyOdr_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
...
this.onBetween(newv,this.oldId + 'time',this.oldId + 'timeEd',this.oldId + 'time_empty');this.doLayout();											}
						...
						,{
							...
							,{xtype : 'numberfield',name : 'address',allowDecimals : false}
						...
						,{
							...
							,{xtype : 'numberfield',name : 'counypd',allowDecimals : false}

Ext.define('mvc.view.pdt.PdtAttr.Win',{
...
initComponent : function(){
		...
		anchor : '100%',
		plain : true,
		xtype : Ext.create('mvc.view.pdt.PdtAttr.Form',{	insFlag : this.insFlag})
	},{
		xtype : Ext.create('mvc.view.pdt.PdtAttr.ListForm',{height : 300,border : false })
	}];

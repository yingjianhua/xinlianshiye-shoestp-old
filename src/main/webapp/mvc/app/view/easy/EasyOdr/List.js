Ext.define('mvc.view.easy.EasyOdr.List',{
...
// 	});
		...
		items : [{
				xtype : Ext.create('mvc.view.easy.EasyOdr.ListMain',{
							title : '简单订单管理',
				...
				xtype : Ext.create('mvc.view.easy.EasyOdr.ListLineEasyOdrline',{
							title : '简单订单管理详情',
		...
		if (selection){
			...
			Ext.MessageBox.confirm(msg_confirm_title, msg_confirm_msg,
				function(btn) {
					...
					Ext.Ajax.request({
						url : base_path+'/easy_EasyOdr_delMulti?pkeys='+arr.toString()+'&rowVersions='+arrv.toString(),
...
onSearchAdv : function(){
		var win = Ext.create('mvc.view.easy.EasyOdr.WinSearch',{

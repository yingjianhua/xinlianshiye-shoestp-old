...
/** Created by IntelliJ IDEA. User: lijie@shoestp.cn Date: 2018/12/6 Time: 20:04 */
public class EasyOdrAction extends MgtAction<EasyOdr> {
  ...
  public void list() throws Exception {
    ...
    while (var7.hasNext()) {
      ...
      String country =
          pltCountryDAO.loadById(object.getInt("countryid")).getName(PltConfigDAO.manageLanguage());
      String regionid =
          pltCountryDAO
              .loadProvinceById(object.getInt("regionid"))
              .getName(PltConfigDAO.manageLanguage());

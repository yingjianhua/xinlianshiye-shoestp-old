...
public class OrderView implements BaseView {
  ...
  public void setPayContent(String payContent)
    ...
    if (payContent == null) this.payContent = new HashMap<String, Object>();
    else {
  ...
  public void setShippingCharges(
      BigDecimal shippingCharges, PltErate currency, boolean symbol, boolean shortName) {
  ...
  public void setInsurance(
      BigDecimal insurance, PltErate currency, boolean symbol, boolean shortName) {
  ...
  public void setShippingChargesAndInsurance(
      BigDecimal shippingChargesAndInsurance,
      PltErate currency,
      boolean symbol,
      boolean shortName) {
    this.shippingChargesAndInsurance =
        CurrencyFormatter.format(shippingChargesAndInsurance, currency, symbol, shortName);
  }
  ...
  public void setSubtotal(
      BigDecimal subtotal, PltErate currency, boolean symbol, boolean shortName) {

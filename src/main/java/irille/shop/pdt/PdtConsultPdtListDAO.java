...
public class PdtConsultPdtListDAO {
  ...
  public static ConsultProductView add(Integer product, Integer purchase) {
    PdtConsultPdtList bean =
        Query.SELECT(PdtConsultPdtList.class)
  ...
  //		return BeanBase.list(PdtConsultPdtList.class, PdtConsultPdtList.T.PURCHASE + "=?", false,
  // pkey);
  //	}
  //
  ...
  public static List<PdtConsultPdtList> listByPurchaseSupplier(Integer purchase, Integer supplier) {
    BeanQuery<PdtConsultPdtList> q = Query.SELECT(PdtConsultPdtList.class);
    if (supplier != null)
   ...
   * @author yingjianhua
   */
  public static List<ConsultPdtView> listViewByPurchase(
      Integer purchase, Integer supplier, Language lang) throws JSONException {

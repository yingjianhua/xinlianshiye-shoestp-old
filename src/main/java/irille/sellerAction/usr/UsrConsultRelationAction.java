...
public class UsrConsultRelationAction extends SellerAction<UsrConsultRelation> implements IUsrConsultRelationAction {
	...
	public void page() throws IOException, JSONException {
		if(getSupplier() != null) {
			write(UsrConsultRelationDAO.pagePrivate(getStart(), getLimit(), getSupplier().getPkey(), getCountryName(), getTitle(), PltConfigDAO.supplierLanguage(getSupplier())));
		} else {
			writeTimeout();
		}
	}

...
public class RFQConsultServiceTest extends BaseTest {
  ...
  @Inject private RFQConsultService service;
  ...
  public void testGetDetail() throws JsonProcessingException {
    ...
    RFQConsultView consult = service.getDetail(purchase, consultPkey, null);
  ...
  public void testAddProductRequest() throws JsonProcessingException {
    ...
    RFQConsultView detail2 = service.getDetail(purchase, consultPkey, null);
    System.out.println(om.writeValueAsString(detail2));
    String products = "339,340";
    service.addProductRequest(purchase, consultPkey, products, null);
    RFQConsultView detail = service.getDetail(purchase, consultPkey, null);

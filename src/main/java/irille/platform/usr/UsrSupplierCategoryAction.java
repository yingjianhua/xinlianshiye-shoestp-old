...
public class UsrSupplierCategoryAction extends ActionBase<UsrSupplierCategory> {
  ...
  @Getter @Setter private Integer supplierCategory;
  @Getter @Setter private Integer id;
  @Getter @Setter private String ids;

  /** @Description: 获取供应商分类 *@date 2019/1/21 16:45 *@anthor zjl */
  public void getUsrSupplierCategoryList() throws IOException {
    write(
        UsrSupplierCategoryDAO.getUsrSupplierCategoryList(
            getStart(), getLimit(), name, supplierCategory));
  }

  /** @Description: 删除多个订阅以及单个 *@date 2019/1/21 14:14 *@anthor zjl */
  ...
  /** @Description: 修改供应商分类 *@date 2019/1/21 20:37 *@anthor zjl */

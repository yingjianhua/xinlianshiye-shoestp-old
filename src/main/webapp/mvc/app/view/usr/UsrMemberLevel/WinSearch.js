Ext.define('mvc.view.usr.UsrMemberLevel.WinSearch',{
extend : 'Ext.window.Window',
oldId : 'UsrMemberLevel_searchWin_',
width : 680,
layout : 'fit',
resizable : true,
iconCls : 'app-icon',
			...
			items : [{
					...
					items : [{
						...
						,{
								...
								mvc.Tools.crtComboBase(false,{
											name : 'optcht_discount',
											width : 80,
											value : 3,
											store : numstore
										})
							,{xtype : 'numberfield',name : 'discount',decimalPrecision : 2}
						...
						,{
							...
							,{xtype : 'numberfield',name : 'levelUp',decimalPrecision : 2}

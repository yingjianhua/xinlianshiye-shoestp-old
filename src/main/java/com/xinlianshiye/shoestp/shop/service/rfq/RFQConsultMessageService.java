...
public interface RFQConsultMessageService {
	 ...
	 * @param messageStartPkey 从指定message开始查询
	 * @param start 开始记录数
	 * @param limit 每页记录数
	 * @author Jianhua Ying
	 * @return 
	 */
	RFQConsultMessagesView page(UsrPurchase purchase, Integer relationPkey, Integer messageStartPkey, Integer start, Integer limit);

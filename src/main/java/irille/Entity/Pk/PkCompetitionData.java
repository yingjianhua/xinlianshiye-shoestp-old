...
/** Created by IntelliJ IDEA. User: lijie@shoestp.cn Date: 2018/12/3 Time: 10:51 */
public class PkCompetitionData extends BeanInt<PkCompetitionData> {
  public static final Tb TB =
      new Tb(PkCompetitionData.class, "PK大赛数据统计").setAutoIncrement().addActList();

...
public class Plt_Install extends InstallBase {
  ...
  private void initPltErate() {
    if (BeanBase.list(PltErate.class, null, false).size() > 0) return;
    PltErateDAO.InsInit ins = new PltErateDAO.InsInit();
    List<PltErate> list = new ArrayList<>();
    list.add(
        PltErateDAO.InsInit.build(
            "",
            "USD",
            "$",
            true,
    ...
    list.add(
        PltErateDAO.InsInit.build(
            ...
            false,
            false,
            BigDecimal.valueOf(06330),
            false,
            BigDecimal.valueOf(0.6330),
            1));
    list.add(
        PltErateDAO.InsInit.build(
            "",
  ...
  private void initPltCountry() {
    if (BeanBase.list(PltCountry.class, null, false).size() > 0) return;
    PltCountryDAO.InsInit ins = new PltCountryDAO.InsInit();
    List<PltCountry> list = new ArrayList<>();
    list.add(
        PltCountryDAO.InsInit.build("Afghanistan", "AF", "+93", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "American Samoa", "AS", "+1684", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Anguilla", "AI", "+1264", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Antigua and Barbuda", "AG", "+1268", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Azerbaijan", "AZ", "+994", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Bangladesh", "BD", "+880", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Barbados", "BB", "+1246", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "Bosnia and Herzegovina", "BA", "+387", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Botswana", "BW", "+267", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Bouvet Island", "BV", "+0", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Brazil", "BR", "+55", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "British Indian Ocean Territory", "IO", "+246", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Brunei Darussalam", "BN", "+673", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Bulgaria", "BG", "+359", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Burkina Faso", "BF", "+226", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Cape Verde", "CV", "+238", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Cayman Islands", "KY", "+1345", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Central African Republic", "CF", "+236", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "Christmas Island", "CX", "+61", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Cocos Islands", "CC", "+672", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Cook Islands", "CK", "+682", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Costa Rica", "CR", "+506", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Cote D'ivoire", "KT", "+225", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "Czech Republic", "CZ", "+420", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Democratic People's Republic of Korea", "KP", "+850", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Democratic Republic of the Congo", "CD", "+243", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Dominica", "DO", "+1767", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("East Timor", "TL", "+670", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("El Salvador", "SV", "+503", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Equatorial Guinea", "GQ", "+240", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "Falkland Islands", "FK", "+500", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Faroe Islands", "FO", "+298", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("French Guiana", "GF", "+594", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "French Polynesia", "PF", "+689", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "French Southern Territories", "TF", "+0", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Gibraltar", "GI", "+350", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Greece", "GR", "+30", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Greenland", "GL", "+299", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Guatemala", "GT", "+502", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Guinea", "GN", "+224", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Guinea-Bissau", "GW", "+245", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "Heard Island and Mcdonald Islands", "HM", "+0", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Honduras", "HN", "+504", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Hong Kong, China", "HK", "+852", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Kyrgyzstan", "KG", "+996", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Liechtenstein", "LI", "+423", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Lithuania", "LT", "+370", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Luxembourg", "LU", "+352", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Macau, China", "MO", "+853", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Macedonia", "MK", "+389", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Madagascar", "MG", "+261", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "Marshall Islands", "MH", "+692", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Martinique", "MQ", "+596", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Mauritania", "MR", "+222", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Mauritius", "MU", "+230", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Micronesia", "FM", "+691", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Montserrat", "MS", "+1664", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Morocco", "MA", "+212", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Mozambique", "MZ", "+258", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Netherlands", "NL", "+31", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("New Caledonia", "NC", "+687", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("New Zealand", "NZ", "+64", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Nicaragua", "NI", "+505", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "Norfolk Island", "NF", "+672", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Northern Mariana Islands", "MP", "+1670", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Palestine", "PS", "+970", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Panama", "PA", "+507", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Papua New Guinea", "PG", "+675", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Philippines", "PH", "+63", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Pitcairn Islands", "PN", "+64", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Puerto Rico", "PR", "+1787", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Saint Helena", "SH", "+247", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Saint Kitts and Nevis", "KN", "+1869", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Saint Lucia", "LC", "+1758", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Saint Pierre and Miquelon", "PM", "+508", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Saint Vincent and the Grenadines", "VC", "+784", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("San Marino", "SM", "+378", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Sao Tome and Principe", "ST", "+239", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Saudi Arabia", "SA", "+966", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Seychelles", "SC", "+248", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Sierra Leone", "SL", "+232", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "Socialist Republic of Vietnam", "VN", "+84", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Solomon Islands", "SB", "+677", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Somalia", "SO", "+252", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("South Africa", "ZA", "+27", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "State of Libya", "LY", "+218", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "Svalbard and Jan Mayen", "SJ", "+0", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Swaziland", "SZ", "+268", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Sweden", "SE", "+46", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Switzerland", "CH", "+41", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Syrian Arab Republic", "SY", "+963", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("TaiWan, China", "TW", "+886", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Tajikistan", "TJ", "+992", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "The Republic of Croatia", "HR", "+385", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "Trinidad and Tobago", "TT", "+1868", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build("Turkmenistan", "TM", "+993", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Turks and Caicos Islands", "TC", "+1649", null, null, true, false, false));
    ...
    list.add(
        PltCountryDAO.InsInit.build(
            "United Arab Emirates", "AE", "+971", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("United Kingdom", "GB", "+44", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("United States", "US", "+1", null, null, true, false, true));
    list.add(
        PltCountryDAO.InsInit.build(
            "United States Minor Outlying Islands", "UM", "+0", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Uruguay", "UY", "+598", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "US Virgin Islands", "VI", "+1340", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Uzbekistan", "UZ", "+998", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Vanuatu", "VU", "+678", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Vatican City State", "VA", "+379", null, null, true, false, false));
    list.add(PltCountryDAO.InsInit.build("Venezuela", "VE", "+58", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Wallis and Futuna Islands", "WF", "+681", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build(
            "Western Sahara", "EH", "+210", null, null, true, false, false));
    list.add(
        PltCountryDAO.InsInit.build("Western Samoa", "WS", "+685", null, null, true, false, false));
  ...
  private void initPltConfig() {
    if (BeanBase.list(PltConfig.class, null, false).size() > 0) return;
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      while ((a = br.readLine()) != null && !a.equals("end")) {
        ...
        pw.println(
            "list.add(PltCountryDAO.InsInit.build(\""
                + name
                + "\", \""
                + shortName
                + "\", \""

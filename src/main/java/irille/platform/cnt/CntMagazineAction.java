...
public class CntMagazineAction extends ActionBase<CntMagazine> {
  ...
  @Getter @Setter private String name; // 查询杂志名称
  @Getter @Setter private Integer id; // 杂志pkey
  ...
  /** @Description: 删除单条杂志 *@date 2019/1/15 14:54 *@anthor zjl */
  ...
  /** @Description: 获取单条杂志 *@date 2019/1/15 15:16 *@anthor zjl */

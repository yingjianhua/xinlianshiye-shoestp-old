...
public class sendHttpsUtils {
  ...
  public static void main(String[] args) throws Exception {
    System.out.println(
        get(
            "https://maps.googleapis.com/maps/api/place/findplacefromtext/json?input=wenzhou+Museum&inputtype=textquery&fields=formatted_address%2Cname%2Crating%2Cgeometry&key=AIzaSyCPbc3yNYQgVc56qbUuAY_Yap-uDMkDkvc",
            "127.0.0.1", 1080));
  }
}

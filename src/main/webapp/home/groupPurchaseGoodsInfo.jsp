                                ...
                                <ul class="list" style="width: 47px; height: 380px;" binding="${imgs.key.pkey}">
                                    <c:forTokens items="${product.picture}" delims="," var="pic">
                                        <li class="item FontBgColor" pos="${index.index}"><!-- 点击图片后添加样式 current-->
                                            <a href="javascript:;" class="pic_box FontBorderHoverColor thumbnail" alt=""
                                        ...
                                        <c:forEach items="${imgs.value}" var="img" varStatus="index">
                                            <c:if test="${not empty img}">
                                                <li class="item FontBgColor" pos="${index.index}">
                                                    <!-- 点击图片后添加样式 current-->
                                                    <a href="javascript:;"
                                                       class="pic_box FontBorderHoverColor thumbnail" alt="" title=""
                                                       hidefocus="true">
                                                        <img class="lazy" src="./static/images/blank.gif"
                            ...
                            <div class="magnify" data="">
                                ...
                                <div class="detail_img_box"
                                    ...
                                    <img class="detail_img lazy" onerror="$.imgOnError(this)"
                                         src="./static/images/blank.gif" data-original="./static/images/189feda440.jpg"

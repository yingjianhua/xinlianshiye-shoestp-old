...
public class BaseExcel {
  ...
  @Getter private String suffix = "xlsx";
  ...
  public static ByteArrayOutputStream toZipOutputStream(
      List<ToZipOutputStream> zipOutputStreamList) {
    ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
    try (ZipOutputStream zipOutputStream =
        new ZipOutputStream(byteArrayOutputStream, Charset.forName("utf-8")); ) {
      for (ToZipOutputStream toZipOutputStream : zipOutputStreamList) {
        zipOutputStream.putNextEntry(
            new ZipEntry(toZipOutputStream.getName() + "." + toZipOutputStream.getSuffix()));

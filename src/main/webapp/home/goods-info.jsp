...
<head>
    ...
    <script type="text/javascript" src="/static/js/plugins/goodsInfo/jquery.SuperSlide.2.1.1.js"></script>
...
<div id="app">
    ...
    <div class="xmgLuyou w1200">
        <ul>
            ...
            <li v-for="(v,index) in goodsInfo.breadcrumbNav" v-if="goodsInfo.breadcrumbNav" :key="v.pkey"
        ...
        <div class="xmgSeleBOX clearfloat">
            ...
            <div class="xmgL fl">
                ...
                <div class="picScroll-top">
                    ...
                    <div class="bd">
                        <ul class="picList">
                            <li :class="index===0?'select':''" v-for="(v,index) in goodsInfo.pdtImg">
                                <div class="pic">
            ...
            <div class="xmgR fr">
                ...
                <div class="xmgT3 info_review clearfloat">
                    ...
                    <div class="fr">
                        ...
                        <ul class="fl">
                            ...
                            <li>
                                <a href="javascript:;" class="share_s_twitter" @click="shareThis('twitter')">twitter</a>
                            </li>
                            <li>
                                <a href="javascript:;" class="share_s_googleplus" @click="shareThis('googleplus')">googleplus</a>
                            </li>
                            <li>
                                <a href="javascript:;" class="share_s_pinterest" @click="shareThis('pinterest')">pinterest</a>
                            </li>
                            <li class="xmgMoreBtn">
                                <a href="javascript:;" class="xmgMore"><s:text name="more"/></a>
                                <div class="xmgHover">
                                    <a href="javascript:;" id="linkedin" @click="shareThis('linkedin')">
                                    ...
                                    <a href="javascript:;" id="stumbleupon" @click="shareThis('stumbleupon')">
                                        <i class="share_s_stumbleupon"></i>
                                        <span>stumbleupon</span>
                                    </a>
                                    <a href="javascript:;" id="delicious" @click="shareThis('delicious')">
                ...
                <div class="xmgForm" name="xmgForm" id="goodsForm">
                    ...
                    <div class="xmgSeleSize">
                        <div class="xmgSsBOX">
                            <form action="/home/odr_OdrOrder_toSettlementPage" method="post" id="buynow">
                                <input type="hidden" name="jsonCarts" :value="_jsonCarts" class="carts">
                            ...
                            <ul>
                                <li v-for="(v,index) in _specList" :specid="v.id">
                                    ...
                                    <span>{{v.price}}</span>
                                    <div class="column">
                                        <a href="javascript:void(0);" :class="(_spceCat(v.id)-1<0)?'disable sub':'sub'"
                                           @click="subSpec(v.id)">-</a>
                                        <input type="text" class="buy" v-model="status.cat[v.id]"
                                               onkeyup='this.value=this.value.replace(/[^0-9]/g,"")'>
                                        <a href="javascript:void(0);" class="add" @click="addSpec(v.id)">+</a>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="xmgActions">
                        ...
                        <input type="button" value="<s:text name='Global.Add_To_Cart'/>" class="addtoCart"
                               @click="addtoCart">
                        <input type="button" value="<s:text name='Global.Buy_Now'/>" class="buyNow" @click="buy">

                        <a href="javascript:;" :class="goodsInfo.favorite?'fav_ed_btn':''" @click="addfav">
                            <span>  &nbsp;</span>
                        </a>
                    </div>
                ...
                <div class="pdContent editorTxt">
                    <div class="desc">
                        <div class="itemSpecifics clearfloat">
                            ...
                            <div class="clean">
                                <div class="fl" style="width:50%;" v-for="(v,k,index) in goodsInfo.specifications">
                                    <span><strong>{{k}}:</strong><label v-for="vv,index in v">{{vv}}</label></span>
                                </div>
                            </div>
        ...
        <div id="review_box">
            <div class="widget prod_write_review">
                ...
                <div class="average_rating">
                    ...
                    <a class="review_nums" :href="'/home/pdt_PdtProduct_writeComment?id='+goodsInfo.pdtId"></a>
                    <div>
                        <a class="review_nums" href="#"></a>
                        <a :href="'/home/pdt_PdtProduct_writeComment?id='+goodsInfo.pdtId" class="write_review_btn"
                ...
                <div class="widget pro`d_recent_review"
                    ...
                    <div class="widget review_item" v-for="(d,index) in goodsInfo.comment">
                        <ul class="user fl">
                            ...
                            <li><span class="by_text"><s:text name="by"/></span><span>{{d.name}}</span></li>
                            <li><i class="icon_level"><img
                                    :src="image(d.usrMemberLevelIco)"></i><strong
                                    class="level_text FontColor">{{d.usrMemberLevelName}}</strong></li>
                        ...
                        <div class="like fr">
                            <div class="vote">
                                ...
                                <div class="likeWrapper">
                                    ...
                                    <span class="gap">|</span>
                                    <a href="javascript:void(0)" class="unlike" @click="vote(d.id,0)"><span
                            ...
                            <a :href="'https://api.addthis.com/oexchange/0.8/forward/facebook/offer?url='+encodeURIComponent(window.location.href)+'&t='+goodsInfo.pdtName"
                               class="fb_share" target="_blank">
                                <em class="icon_facebook_mini"></em><s:text name="products.shareFB"/>
                            </a>
                        </div>
                        <div class="main">
                            ...
                            <div class="reply">
                                <div class="edit"><a href="javascript:;" class="reply_btn"
                                                     @click="changeShow(d.id)"><s:text name="reply"/></a></div>
                                <div class="w_review_replys" v-show="_isShowReply(d.id)">
                                    <span class="arrow"></span>
                                    <div class="review_reply">
                                        <p>{{d.reply}}</p>
                                        <p class="writer"><span class="light_gray"><s:text name="By"/></span> <cite
                ...
                <%--查看所有评论--%>
                <div class="prod_review_view" v-if="isLogin && goodsInfo.comment&& goodsInfo.comment.length>0">
                    <div class="blank12"></div>
                    <a class="customer_btn clearfix" :href="'/home/pdt_PdtProduct_viewComments?id='+goodsInfo.pdtId">
...
<script>
    ...
    var app = new Vue({
        ...
        data: {
            ...
            image(v, params) {
                if (!v) {
                    return "/home/static/images/85bb6f7a6c.png"
                }
                if (!params) {
                    params = ""
                }
                ...
                if (i > 0) {
                    axios({
                        ...
                        if (data.data.success) {
                            //TODO
                            $("div.fr.top_cart.top_cart0 i").text(data.data.newQty + parseInt($("div.fr.top_cart.top_cart0 i").text()))
...
//			alert($(this).find("img").attr("src"))
        ...
        $("#small-box").find("img").removeAttr('src').attr("src", thissrc + "?x-oss-process=image/resize,m_pad,h_500,w_500");
    ...
    window.onload = function () {
        ...
        objMark.onmousemove = function (ev) {
            ...
            var left = _event.clientX - objBox.offsetLeft - objSmallBox.offsetLeft - objFloatBox.offsetWidth / 2 + document.body.scrollLeft;
            var top = _event.clientY - objBox.offsetTop - objSmallBox.offsetTop - objFloatBox.offsetHeight / 2 + document.body.scrollTop;
            //设置边界处理，防止移出小图片
            if (left < 0) {
                left = 0;

...
public class DataInfoAction extends HomeAction<DataInfo>{
	...
	//String [] nameArray={"Lisa","Sandra","Shirley","Scott","Maria","Barbara","Jason","Angela","Patricia","Maria","Kenneth","Brian","Jessica","Edward","Jason","Mark","Helen","George","Charles","Daniel","Jeffrey","Matthew","Christopher","Patricia","Donald","Michael","Linda","Matthew","Elizabeth"};
	//String [] dateArray={"2018-10-17","2018-10-18","2018-10-19","2018-10-20","2018-10-21","2018-10-16","2018-10-15","2018-10-14","2018-10-13"};	
	String [] status={"待付款","已付款"};
	String [] amount={"32,154.00","62,124.80","12,204.00","2,354.00","7,154.00","11,380.00","9,274.00","10,306.00","42,184.00","2,156.00","8,871.00","22,764.00","12,334.00","6,158.00","1,154.00","9,159.00","5,158.00","6,808.00","62,750.00","12,880.00","6,159.00","32,154.00","7,764.00"};
	...
	if(type!=null&&type.equals("1")){
		...
		//List<DataInfo> odrInfList=BeanBase.list(DataInfo.class," ORDER BY " + DataInfo.T.DATE.getFld().getCodeSqlField() + " DESC LIMIT(0,20)",false);	
		SQL sql = new SQL(){{
	...
	public void  getRegAndConsult() throws Exception{
		String [] countryArray={"西班牙","意大利","罗马尼亚","匈牙利","俄罗斯"};
		//String [] nameArray={"Lisa","Sandra","Shirley","Scott","Maria","Barbara","Jason","Angela","Patricia","Maria","Kenneth","Brian","Jessica","Edward","Jason","Mark","Helen","George","Charles","Daniel","Jeffrey","Matthew","Christopher","Patricia","Donald","Michael","Linda","Matthew","Elizabeth"};	
		//String [] title={"Romania Wholesale Shoes...","Juna ladies dress shoes...","FOLLOW ME girls...","Women's Chic Pointed...","Aokang official men's...","British Style Simple Ankle Shoes...","Men's casual velcro soft sandals...","Chunky heel single shoes..."};
		if(type.equals("1")){
		for (int i = 0; i <20; i++) {

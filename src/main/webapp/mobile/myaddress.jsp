                    ...
                    <div class="info" data-url="/account/address/?Form=1&amp;AId=467">
                        ...
                        <c:forEach items="${usrPurchaseLine}" varStatus="status">
                            <c:if test="${usrPurchaseLine[status.index].addrsstype == 1}">
                                ...
                                <strong>
                                        ${usrPurchaseLine[status.index].name}
                                    ${usrPurchaseLine[status.index].surname}<!--姓名 姓氏  -->
                                </strong>
                                <p>
                                        ${usrPurchaseLine[status.index].address} ${usrPurchaseLine[status.index].city} ${usrPurchaseLine[status.index].region} ${usrPurchaseLine[status.index].emailcode}
                                    ${usrPurchaseLine[status.index].country}<!--详细地址 城市 省 邮编 国家 -->
                                </p>

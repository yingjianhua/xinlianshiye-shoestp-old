...
<script src="/activity/Pk/js/vue.js"></script>
...
<div id="hoodle" v-if="is()">
    <div class="hoodle" :class="{hoodle_show : hoodleShow}">
        <img src="/activity/Pk/imgs/hoodle.png" width="800" @click="skip">
        <div class="hoodle-close" @click="hoodleShow = false;"></div>
    </div>
...
<script>
    new Vue({
        ...
        methods: {
            is(){
              return stpshop_config.lang === 'zh_CN';
            },

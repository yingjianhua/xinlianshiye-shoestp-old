...
public class PdtProduct extends BeanInt<PdtProduct> implements IExtName, ISeq {
  ...
  public enum T implements IEnumFld { // @formatter:off
    ...
    IS_VERIFY(Tb.crt(Pdt.OAppr.DEFAULT)), // 是否审核通过 产品审核状态
  ...
  public SysUser gtVerifyBy() {
    if (getVerifyBy() == null) return null;
    return (SysUser) get(SysUser.class, getVerifyBy());
  }

  public void stVerifyBy(SysUser verifyBy) {
    if (verifyBy == null) setVerifyBy(null);
    else setVerifyBy(verifyBy.getPkey());
  }
  ...
  public UsrProductCategory gtCategoryDiy() {
    if (getCategoryDiy() == null) return null;
  ...
  public void stCategoryDiy(UsrProductCategory categoryDiy) {
    if (categoryDiy == null) setCategoryDiy(null);
    else setCategoryDiy(categoryDiy.getPkey());
  }
  ...
  public PdtProduct gtSourceProduct() {
    if (getSourceProduct() == null) return null;
    return (PdtProduct) get(PdtProduct.class, getSourceProduct());
  }

  public void stSourceProduct(PdtProduct sourceProduct) {
    if (sourceProduct == null) setSourceProduct(null);
    else setSourceProduct(sourceProduct.getPkey());
  }
  ...
  public void setDescribeModule1(String describeModule1, FldLanguage.Language l)
  ...
  public void setDescribeModule2(String describeModule2, FldLanguage.Language l)
      throws JSONException {
  ...
  public void setDescribeModule3(String describeModule3, FldLanguage.Language l)
      throws JSONException {

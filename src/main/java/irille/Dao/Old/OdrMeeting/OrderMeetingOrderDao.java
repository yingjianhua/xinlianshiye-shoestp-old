            ...
            .map(
                o -> {
                  ...
                  view.setOrderId(
                      Integer.valueOf(
                          String.valueOf(
                              o.get(OrderMeetingOrder.T.PKEY.getFld().getCodeSqlField()))));
                  view.setWhetherToSend(
                      Integer.valueOf(
                          String.valueOf(
                              o.get(
                                  OrderMeetingOrder.T
                  ...
                  view.setSupplier(
                      Integer.valueOf(
                          String.valueOf(
                              o.get(OrderMeetingOrder.T.PARTNER.getFld().getCodeSqlField()))));
                  view.setProduct(
                      Integer.valueOf(
                          String.valueOf(o.get(PdtSpec.T.PRODUCT.getFld().getCodeSqlField()))));
                  view.setOrderNum(
                      String.valueOf(o.get(OdrOrder.T.ORDER_NUM.getFld().getCodeSqlField())));
                  view.setEmail(
                      String.valueOf(o.get(UsrPurchase.T.EMAIL.getFld().getCodeSqlField())));
                  view.setProdPrice(
                      BigDecimal.valueOf(
                          Double.valueOf(
                              String.valueOf(
                                  o.get(OdrOrder.T.PROD_PRICE.getFld().getCodeSqlField())))));
                  view.setPriceTotal(
                      BigDecimal.valueOf(
                          Double.valueOf(
                              String.valueOf(
                                  o.get(OdrOrder.T.PRICE_TOTAL.getFld().getCodeSqlField())))));
                  view.setOrderStatus(
                      Integer.valueOf(
                          String.valueOf(o.get(OdrOrder.T.STATE.getFld().getCodeSqlField()))));
                  view.setCountry(
                      String.valueOf(o.get(PltCountry.T.NAME.getFld().getCodeSqlField())));
                  view.setPaymentTime(
                      String.valueOf(
                          o.get(OrderMeetingOrder.T.PAYMENTTIME.getFld().getCodeSqlField())));
                  view.setWhetherSettlement(
                      Integer.valueOf(
                          String.valueOf(
                              o.get(
                                  OrderMeetingOrder.T.BILLINGSTATUS.getFld().getCodeSqlField()))));

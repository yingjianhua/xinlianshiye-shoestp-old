...
public class PltFreightAction extends MgtAction<PltFreight> {
  ...
  @Inject private PltFreightDao pltFreightDAO;
  @Getter @Setter private Integer id;
  @Getter @Setter private FreightManagementView freightManagementView;
  @Getter @Setter private DeliveryAreaView deliveryAreaView;
  @Getter @Setter private PltFreightLine beanline;
  /** @Description: (平台)获取运费管理列表 *@date 2019/1/3 16:33 *@anthor zjl */
  @Setter @Getter private String selectcompany;

  public void getShippingList() throws IOException {
    write(pltFreightDAO.getShippingList(selectcompany, getStart(), getLimit()));
  }

  /** @Description: (平台)获取配送区域列表 *@date 2019/1/3 16:49 *@anthor zjl */
  public void getDeliveryAreaList() throws IOException {
    write(pltFreightDAO.getDeliveryAreaList(id));
  }

  /** @Description: (平台)新增运费管理 *@date 2019/1/4 9:56 *@anthor zjl */
  ...
  /** @Description: (平台)新增配送区域 *@date 2019/1/4 10:16 *@anthor zjl */
  public void insDeliveryArea() throws IOException {
    pltFreightDAO.insDeliveryArea(beanline);
    write();
  }

  /** @Description: (平台)获取单个运费管理 *@date 2019/1/4 11:03 *@anthor zjl */
  public void getShipping() throws IOException {
    write(pltFreightDAO.getShipping(id));
  }

  /** @Description: (平台)修改单个运费管理 *@date 2019/1/4 11:26 *@anthor zjl */
  ...
  /** @Description: (平台)获取单个配送区域 *@date 2019/1/4 11:52 *@anthor zjl */
  public void getDeliveryArea() throws IOException {
    write(pltFreightDAO.getDeliveryArea(id));
  }

  /** @Description: (平台)更新单个配送区域 *@date 2019/1/4 13:54 *@anthor zjl */

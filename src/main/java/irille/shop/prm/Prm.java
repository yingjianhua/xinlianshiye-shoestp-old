...
public class Prm extends PackageBase{
	...
	public enum OStatus implements IEnumOpt{
		NOTSTART(0,"未开始"),SOONSTART(1,"即将开始"),HAVEINHAND(2,"进行中"),SOONEND(3,"即将结束"),END(4,"已结束"),DELETE(5,"逻辑删除");
	...
	public enum OSend implements IEnumOpt{
		NOSEND(0,"未发送"),ALSEND(1,"已发送");
		public static final String NAME = "明细状态";
		public static final OSend DEFAULT = NOSEND;
		private EnumLine _line;
		private OSend(int key , String name){_line = new EnumLine(this,key,name);}
		public EnumLine getLine(){return _line;}
	}
	
	public enum OPreTime implements IEnumOpt{
		THREEDAY(3,"提前三天"),SEVENDAY(7,"提前七天"),FIFTEENDAY(15,"提前十五天"),MONTH(30,"提前一个月");
		
		public static final String NAME = "提前预告";
		public static final OPreTime DEFAULT = MONTH;
		private EnumLine _line;
		private OPreTime(int key , String name){_line = new EnumLine(this,key,name);}
		public EnumLine getLine(){return _line;}
	}

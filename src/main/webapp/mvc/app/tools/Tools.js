(function () {
    ...
    Ext.apply(mvcTools, {
        ...
        imgRenderer: function (width, height, params) {
            return function (v) {
                if (!v && v !== 0)
                    return "";
                var html = '<img src="'
        ...
        crtStatisticsStore: function (param) {
            Ext.define('Statistics', {
                extend: 'Ext.data.Model',
                fields: [
                    {name: 's0', type: 'string'}, {name: 'f1', type: 'float'}, {name: 'f2', type: 'float'}, {
                        name: 'f3',
                        type: 'float'
                    }, {name: 'f4', type: 'float'},
                    {name: 'f5', type: 'float'}, {name: 'f6', type: 'float'}, {
                        name: 'f7',
                        type: 'float'
                    }, {name: 'f8'}, {name: 'f9', type: 'float'},
                    {name: 'f10', type: 'float'}, {name: 'f11', type: 'float'}, {
                        name: 'f12',
                        type: 'float'
                    }, {name: 'f13', type: 'float'}, {name: 'f14', type: 'float'},
                    {name: 'f15', type: 'float'}, {name: 'f16', type: 'float'}, {
                        name: 'f17',
                        type: 'float'
                    }, {name: 'f18', type: 'float'}, {name: 'f19', type: 'float'}
                ]
            });
            return Ext.create('Ext.data.Store', {
                model: 'Statistics',

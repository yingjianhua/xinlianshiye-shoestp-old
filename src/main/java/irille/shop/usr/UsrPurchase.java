...
@Variable(
    group = {OTempType.INQUIRY_NOTICE_SUPPLIER, OTempType.PURCHASE_FORGET_PASSWORD},
    enumType = UsrPurchase.T.class,
    clazz = UsrPurchase.class,
    attributes = {
...
public class UsrPurchase extends BeanInt<UsrPurchase> implements IExtName {
  ...
  public static final Tb TB = new Tb(UsrPurchase.class, "采购商").setAutoIncrement().addActList();

 ...
 * @author surface1
 */
public class CntSglPageCategory extends BeanInt<CntSglPageCategory>
    implements IExtName { // implements ICmbRpRpt{
  /** setAutoIncrement 设置自增 addActIUDL 增加IUDL 按钮 addActEnabled 增加启用按钮 */
  public static final Tb TB =
      new Tb(CntSglPageCategory.class, "单页类型").setAutoIncrement().addActIUDL();

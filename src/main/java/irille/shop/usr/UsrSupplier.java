...
public class UsrSupplier extends BeanInt<UsrSupplier> implements IExtName {
  ...
  public UsrSupplier init() {
    ...
    _companyIntroductionPageCustomDecorationOn = OYn.DEFAULT.getLine()
        .getKey();  // 公司介绍页自定义装修开关 <OYn>  BYTE
  ...
  public JSONObject gtCompanyIntroductionPageCustomDecoration() throws JSONException {
    return getCompanyIntroductionPageCustomDecoration() == null ? new JSONObject()
  ...
  public void stCompanyIntroductionPageCustomDecoration(
    ...
    setCompanyIntroductionPageCustomDecoration(
        companyIntroductionPageCustomDecoration == null ? null
  ...
  public void setCompanyIntroductionPageCustomDecoration(
    ...
    stCompanyIntroductionPageCustomDecoration(gtCompanyIntroductionPageCustomDecoration()
  ...
  public void stCompanyIntroductionPageCustomDecorationOn(
    ...
    _companyIntroductionPageCustomDecorationOn = booleanToByte(
        companyIntroductionPageCustomDecorationOn);
  }

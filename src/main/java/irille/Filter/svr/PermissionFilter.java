...
/** Created by IntelliJ IDEA. User: lijie@shoestp.cn Date: 2018/8/15 Time: 15:56 */
public class PermissionFilter implements Filter {
  ...
  public void doFilter(
    ...
    if (request.getServletPath().substring(0, 19).equalsIgnoreCase("/seller/admin/index")) {
      if (!request.getServletPath().equalsIgnoreCase("/seller/admin/index/login.html")
          && (sessionmsg == null
              || !sessionmsg.isSupplier()
              || sessionmsg.getSupplier().gtStatus() == OStatus.INIT)) {

...
public class Odr extends PackageBase {
	...
	public enum OdrState implements IEnumOpt{//@formatter:off
		...
		private OdrState(int key, String name) {_line=new EnumLine(this,key,name);	}
		@Override
	...
	public enum CancelType implements IEnumOpt{//@formatter:off
		...
		private EnumLine _line;
		private CancelType(int key, String name) {_line=new EnumLine(this,key,name);	}
		@Override
		public EnumLine getLine() {
			return _line;
		}
	...
	public enum PayType implements IEnumOpt{//@formatter:off
		...
		private EnumLine _line;
		private PayType(int key, String name) {_line=new EnumLine(this,key,name);	}
		@Override
		public EnumLine getLine() {
			// TODO Auto-generated method stub
			return _line;
	...
	public enum OdrType implements IEnumOpt{//@formatter:off
		...
		private EnumLine _line;
		private OdrType(int key, String name) {_line=new EnumLine(this,key,name);	}
		@Override
		public EnumLine getLine() {
			// TODO Auto-generated method stub
			return _line;

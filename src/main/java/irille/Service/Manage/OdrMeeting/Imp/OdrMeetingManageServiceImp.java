...
public class OdrMeetingManageServiceImp implements IOdrMeetingManageService {
  ...
  @Inject private OdrMeetingInsDao odrMeetingInsDao;

  @Inject private OdrMeetingAuditInsDao odrMeetingAuditInsDao;

  @Inject private OrderMeetingAuditDao orderMeetingAuditDao;
  ...
  @Override
  public Page getMyOdrMeetingList(
      Integer start,
      Integer limit,
      String name,
      Integer supstate,
  ...
  @Override
  public Page getMyJoinOdrMeetingList(
  ...
  @Override
  public Page getMyOtherOdrMeetingList(
      Integer start, Integer limit, String name, Integer state, Integer supplierpkey) {
  ...
  @Override
  public Page getMeetingSaleInfo(int start, int limit, int odrMeeting, int supplierId) {

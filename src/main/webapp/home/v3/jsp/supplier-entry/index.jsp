...
<script>
    ...
    new Vue({
        ...
        methods: {
            sss(){
                var begin = Date.parse(new Date(this.supplier.businessLicenseBeginTime))
                var end = Date.parse(new Date(this.supplier.businessLicenseEndTime))
                if (begin > end && this.supplier.businessLicenseIsSecular === '0') {
                    return false
                }
            },
            //获取信息,判断是否修改
